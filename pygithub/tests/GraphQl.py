...
class GraphQl(Framework.TestCase):
    ...
    def testRequesterGraphQlPrefix(self):
        get_graphql_prefix = pygithub.Requester.Requester.get_graphql_prefix
        assert "/graphql" == get_graphql_prefix(None)
        assert "/graphql" == get_graphql_prefix("")
        assert "/graphql" == get_graphql_prefix("/")
        assert "/api/graphql" == get_graphql_prefix("/api/v3")
        assert "/path/to/pygithub/api/graphql" == get_graphql_prefix("/path/to/pygithub/api/v3")
        assert "/path/to/pygithub/graphql" == get_graphql_prefix("/path/to/pygithub")
