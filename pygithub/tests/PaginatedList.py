...
from pygithub.PaginatedList import PaginatedList as PaginatedListImpl
...
class PaginatedList(Framework.TestCase):
    ...
    def testCustomPerPageWithNoUrlParams(self):
        from . import (  # Don't polute pygithub.tests namespace, it would conflict with pygithub.tests.CommitComment
            CommitComment,
        )
