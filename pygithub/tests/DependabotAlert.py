...
class DependabotAlert(Framework.TestCase):
    alert: pygithub.DependabotAlert.DependabotAlert
    ...
    def testMultipleAlerts(self):
        ...
        self.assertIsInstance(multiple_alerts, pygithub.PaginatedList.PaginatedList)
        self.assertIsInstance(multiple_alerts[0], pygithub.DependabotAlert.DependabotAlert)
