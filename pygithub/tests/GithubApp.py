...
class GithubApp(Framework.TestCase):
    def setUp(self):
        super().setUp()
        self.app_slug = "pygithub-actions"
    ...
    def testGetPublicApp(self):
        ...
        self.assertEqual(app.owner.login, "pygithub")
        ...
        self.assertEqual(app.slug, "pygithub-actions")
        self.assertEqual(app.updated_at, datetime(2019, 12, 10, 19, 4, 12, tzinfo=timezone.utc))
        self.assertEqual(app.url, "/apps/pygithub-actions")
    ...
    def testGetAuthenticatedApp(self):
        ...
        with self.assertWarns(DeprecationWarning) as warning:
            ...
            self.assertWarning(
                ...
                "please use pygithub.GithubIntegration(auth=pygithub.Auth.AppAuth(...)).get_app() instead",
            )
