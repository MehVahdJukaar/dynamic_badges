...
class Environment(Framework.TestCase):
    ...
    def testReviewers(self):
        ...
        self.assertIsInstance(reviewers[0].reviewer, pygithub.NamedUser.NamedUser)
        # Make type checker happy
        assert isinstance(reviewers[0].reviewer, pygithub.NamedUser.NamedUser)
        ...
        self.assertIsInstance(reviewers[1].reviewer, pygithub.Team.Team)
        # Make type checker happy
        assert isinstance(reviewers[1].reviewer, pygithub.Team.Team)
    ...
    def testUpdateEnvironment(self):
        environment = self.repo.create_environment(
            "test",
            wait_timer=42,
            reviewers=[pygithub.EnvironmentProtectionRuleReviewer.ReviewerParams(type_="User", id_=19245)],
            deployment_branch_policy=pygithub.EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams(
    ...
    def testDeleteEnvironment(self):
        ...
        with pytest.raises(pygithub.UnknownObjectException):
