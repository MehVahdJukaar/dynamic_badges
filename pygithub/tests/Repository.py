...
# Copyright 2021 karsten-wagner <39054096+karsten-wagner@users.noreply.pygithub.com>#
...
class Repository(Framework.TestCase):
    ...
    def testAttributes(self):
        ...
        self.assertEqual(self.repo.git_url, "git://pygithub.com/jacquev6/PyGithub.git")
        ...
        self.assertEqual(self.repo.ssh_url, "git@pygithub.com:jacquev6/PyGithub.git")
    ...
    def testCreateGitTree(self):
        tree = self.repo.create_git_tree(
            [pygithub.InputGitTreeElement("Foobar.txt", "100644", "blob", content="File created by PyGithub")]
        )
    ...
    def testCreateGitCommitWithAllArguments(self):
        ...
        commit = self.repo.create_git_commit(
            ...
            tree,
            [],
            pygithub.InputGitAuthor("John Doe", "j.doe@vincent-jacques.net", "2008-07-09T16:13:30+12:00"),
            pygithub.InputGitAuthor("John Doe", "j.doe@vincent-jacques.net", "2008-07-09T16:13:30+12:00"),
        )
    ...
    @mock.patch("pygithub.PublicKey.encrypt")
    ...
    def testCodeScanAlerts(self):
        ...
        self.assertEqual(
            ...
            'analysis_key=".pygithub/workflows/codeql-analysis.yml:analyze"'
            ")",
        )
        self.assertEqual(instance.ref, "refs/heads/master")
        self.assertEqual(instance.analysis_key, ".pygithub/workflows/codeql-analysis.yml:analyze")
    ...
    def testGetHookDelivery(self):
        ...
        self.assertIsInstance(delivery.request, pygithub.HookDelivery.HookDeliveryRequest)
        ...
        self.assertIsInstance(delivery.response, pygithub.HookDelivery.HookDeliveryResponse)
    ...
    def testCreateFile(self):
        ...
        author = pygithub.InputGitAuthor("Enix Yu", "enix223@163.com", "2016-01-15T16:13:30+12:00")
    ...
    def testUpdateFile(self):
        ...
        self.repo.update_file(
            ...
            sha=sha,
            branch="master",
            committer=pygithub.InputGitAuthor("Enix Yu", "enix223@163.com", "2016-01-15T16:13:30+12:00"),
            author=pygithub.InputGitAuthor("Enix Yu", "enix223@163.com", "2016-01-15T16:13:30+12:00"),
        )
    ...
    def testReplaceTopics(self):
        self.repo.replace_topics(["pygithub", "testing"])
