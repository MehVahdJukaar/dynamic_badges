...
class Logging(Framework.BasicTestCase):
    ...
    def testLoggingWithBasicAuthentication(self):
        self.assertEqual(pygithub.Github(auth=self.login).get_user().name, "Vincent Jacques")
        ...
        responseHeaders = {
            "status": "200 OK",
            "content-length": "806",
            "x-pygithub-media-type": "pygithub.beta; format=json",
    ...
    def testLoggingWithOAuthAuthentication(self):
        self.assertEqual(pygithub.Github(auth=self.oauth_token).get_user().name, "Vincent Jacques")
        url = "https://api.github.com/user"
        requestHeaders = {
    ...
    def testLoggingWithoutAuthentication(self):
        self.assertEqual(pygithub.Github().get_user("jacquev6").name, "Vincent Jacques")
    ...
    def testLoggingWithBaseUrl(self):
        ...
        self.assertEqual(
            pygithub.Github(base_url="http://my.enterprise.com/my/prefix").get_user("jacquev6").name,
            "Vincent Jacques",
        )
    ...
    def testLoggingDoesNotModifyRequestHeaders(self):
        ...
        pygithub.Github()._Github__requester._Requester__log(
            "GET",
            "http://example.com",
            requestHeaders,
            None,
