...
from pygithub.Auth import AppAuth, AppInstallationAuth
...
class Installation(Framework.BasicTestCase):
    def setUp(self):
        ...
        self.integration = pygithub.GithubIntegration(auth=self.auth)
    ...
    def testGetGithubForInstallation(self):
        ...
        with self.ignoreWarning(category=InsecureRequestWarning, module="urllib3.connectionpool"):
            ...
            self.integration = pygithub.GithubIntegration(**kwargs)
