...
class AuthenticatedUser(Framework.TestCase):
    ...
    def testCreateGist(self):
        gist = self.user.create_gist(
            True,
            {"foobar.txt": pygithub.InputFileContent("File created by PyGithub")},
    ...
    def testCreateMigration(self):
        self.assertTrue(isinstance(self.user.create_migration(["sample-repo"]), pygithub.Migration.Migration))
