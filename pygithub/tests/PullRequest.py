...
class PullRequest(Framework.TestCase):
    ...
    def testCreateComment(self):
        ...
        comment = self.pull.create_comment("Comment created by PyGithub", commit, "src/pygithub/Issue.py", 5)
    ...
    def testGetFiles(self):
        self.assertListKeyEqual(
            ...
            [
                ...
                "src/pygithub/AuthenticatedUser.py",
                "src/pygithub/Authorization.py",
                "src/pygithub/Branch.py",
                "src/pygithub/Commit.py",
                "src/pygithub/CommitComment.py",
                "src/pygithub/CommitFile.py",
                "src/pygithub/CommitStats.py",
                "src/pygithub/Download.py",
                "src/pygithub/Event.py",
                "src/pygithub/Gist.py",
                "src/pygithub/GistComment.py",
                "src/pygithub/GistHistoryState.py",
                "src/pygithub/GitAuthor.py",
                "src/pygithub/GitBlob.py",
                "src/pygithub/GitCommit.py",
                "src/pygithub/GitObject.py",
                "src/pygithub/GitRef.py",
                "src/pygithub/GitTag.py",
                "src/pygithub/GitTree.py",
                "src/pygithub/GitTreeElement.py",
                "src/pygithub/Hook.py",
                "src/pygithub/Issue.py",
                "src/pygithub/IssueComment.py",
                "src/pygithub/IssueEvent.py",
                "src/pygithub/Label.py",
                "src/pygithub/Milestone.py",
                "src/pygithub/NamedUser.py",
                "src/pygithub/Organization.py",
                "src/pygithub/Permissions.py",
                "src/pygithub/Plan.py",
                "src/pygithub/PullRequest.py",
                "src/pygithub/PullRequestComment.py",
                "src/pygithub/PullRequestFile.py",
                "src/pygithub/Repository.py",
                "src/pygithub/RepositoryKey.py",
                "src/pygithub/Tag.py",
                "src/pygithub/Team.py",
                "src/pygithub/UserKey.py",
                "test/Issue.py",
                "test/IssueEvent.py",
