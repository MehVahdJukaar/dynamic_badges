...
# Copyright 2017 Mike Miller <pygithub@mikeage.net>                              #
...
import pygithub.TimelineEventSource
...
class TimelineEvent(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._source: Attribute[pygithub.TimelineEventSource.TimelineEventSource] = NotSet
    ...
    @property
    def source(self) -> pygithub.TimelineEventSource.TimelineEventSource | None:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "source" in attributes:  # pragma no branch
            self._source = self._makeClassAttribute(
                pygithub.TimelineEventSource.TimelineEventSource, attributes["source"]
            )
