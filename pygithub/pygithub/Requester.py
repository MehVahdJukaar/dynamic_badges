...
# Copyright 2018 R1kk3r <R1kk3r@users.noreply.pygithub.com>                      #
...
# Copyright 2023 adosibalo <94008816+adosibalo@users.noreply.pygithub.com>       #
...
import pygithub.Consts as Consts
import pygithub.GithubException as GithubException
...
class Requester:
    ...
    # keep arguments in-sync with pygithub.MainClass and GithubIntegration
    def __init__(
        self,
        auth: Optional["Auth"],
        base_url: str,
        ...
        assert user_agent is not None, (
            "pygithub now requires a user-agent. "
