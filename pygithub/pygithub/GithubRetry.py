...
class GithubRetry(Retry):
    ...
    # used to mock datetime, mock.patch("pygithub.GithubRetry.date") does not work as this
    # references the class, not the module (due to re-exporting in pygithub/__init__.py)
    __datetime = datetime
            ...
            if response.status == 403:
                ...
                if "Retry-After" in response.headers:
                    ...
                    try:
                        ...
                        # we want to fall back to the actual pygithub exception (probably a rate limit error)
