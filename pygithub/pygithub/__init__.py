...
# Copyright 2020 Emily <pygithub@emily.moe>                                      #
...
"""
The primary class you will instantiate is :class:`pygithub.MainClass.Github`.
...
# set log level to INFO for pygithub
...
def set_log_level(level: int) -> None:
    """
    Set the log level of the pygithub logger, e.g. set_log_level(logging.WARNING)
