...
if TYPE_CHECKING:
    from pygithub.MainClass import Github
...
class Installation(NonCompletableGithubObject):
    ...
    def get_github_for_installation(self) -> Github:
        return pygithub.Github(**self._requester.kwargs)
    ...
    def get_repos(self) -> PaginatedList[pygithub.Repository.Repository]:
        """
        ...
        return PaginatedList(
            contentClass=pygithub.Repository.Repository,
