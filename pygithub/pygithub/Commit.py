...
import pygithub.CommitCombinedStatus
...
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet, Opt, is_optional
...
if TYPE_CHECKING:
    ...
    from pygithub.CommitCombinedStatus import CommitCombinedStatus
    from pygithub.CommitComment import CommitComment
    from pygithub.CommitStats import CommitStats
    from pygithub.CommitStatus import CommitStatus
    from pygithub.File import File
...
class Commit(CompletableGithubObject):
    ...
    def get_combined_status(self) -> CommitCombinedStatus:
        ...
        return pygithub.CommitCombinedStatus.CommitCombinedStatus(self._requester, headers, data, completed=True)
    ...
    def get_pulls(self) -> PaginatedList[PullRequest]:
        ...
        return PaginatedList(
            ...
            f"{self.url}/pulls",
            None,
            headers={"Accept": "application/vnd.pygithub.groot-preview+json"},
        )
    ...
    def get_check_suites(self, app_id: Opt[int] = NotSet, check_name: Opt[str] = NotSet) -> PaginatedList[CheckSuite]:
        ...
        request_headers = {"Accept": "application/vnd.pygithub.v3+json"}
        return PaginatedList(
            pygithub.CheckSuite.CheckSuite,
            self._requester,
