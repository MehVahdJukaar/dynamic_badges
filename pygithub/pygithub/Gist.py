...
# Copyright 2018 羽 <Just4test@users.noreply.pygithub.com>                        #
...
import pygithub.GistComment
import pygithub.GistFile
import pygithub.GistHistoryState
import pygithub.GithubObject
import pygithub.NamedUser
import pygithub.PaginatedList
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet, Opt, _NotSetType, is_defined, is_optional
from pygithub.PaginatedList import PaginatedList

if TYPE_CHECKING:
    from pygithub.GistComment import GistComment
    from pygithub.GistHistoryState import GistHistoryState
...
class Gist(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._files: Attribute[dict[str, pygithub.GistFile.GistFile]] = NotSet
        ...
        self._owner: Attribute[pygithub.NamedUser.NamedUser] = NotSet
    ...
    @property
    def files(self) -> dict[str, pygithub.GistFile.GistFile]:
        self._completeIfNeeded()
        return self._files.value

    @property
    def fork_of(self) -> pygithub.Gist.Gist:
    ...
    @property
    def owner(self) -> pygithub.NamedUser.NamedUser:
    ...
    @property
    def user(self) -> pygithub.NamedUser.NamedUser:
    ...
    def edit(self, description: Opt[str] = NotSet, files: Opt[dict[str, InputFileContent | None]] = NotSet) -> None:
        ...
        assert isinstance(files, _NotSetType) or all(
            element is None or isinstance(element, pygithub.InputFileContent) for element in files.values()
        ), files
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "history" in attributes:  # pragma no branch
            self._history = self._makeListOfClassesAttribute(
                pygithub.GistHistoryState.GistHistoryState, attributes["history"]
            )
