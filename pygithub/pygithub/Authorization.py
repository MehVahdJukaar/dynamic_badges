...
from pygithub.GithubObject import Attribute, NotSet, Opt, _NotSetType

if TYPE_CHECKING:
    from pygithub.AuthorizationApplication import AuthorizationApplication
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        if "app" in attributes:  # pragma no branch
            self._app = self._makeClassAttribute(
                pygithub.AuthorizationApplication.AuthorizationApplication,
                attributes["app"],
            )
