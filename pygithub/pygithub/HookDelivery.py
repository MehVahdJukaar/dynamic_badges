...
from pygithub.GithubObject import Attribute, NotSet


class HookDeliverySummary(pygithub.GithubObject.NonCompletableGithubObject):
    """
...
class HookDeliveryRequest(pygithub.GithubObject.NonCompletableGithubObject):
    """
...
class HookDeliveryResponse(pygithub.GithubObject.NonCompletableGithubObject):
    """
