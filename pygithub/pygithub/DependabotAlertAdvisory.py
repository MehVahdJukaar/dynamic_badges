...
class DependabotAlertAdvisory(pygithub.AdvisoryBase.AdvisoryBase):
    """
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "vulnerabilities" in attributes:
            self._vulnerabilities = self._makeListOfClassesAttribute(
                pygithub.DependabotAlertVulnerability.DependabotAlertVulnerability,
