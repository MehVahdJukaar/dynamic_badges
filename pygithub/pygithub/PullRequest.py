...
# Copyright 2018 Martin Monperrus <monperrus@users.noreply.pygithub.com>         #
# Copyright 2018 Matt Babineau <9685860+babineaum@users.noreply.pygithub.com>    #
# Copyright 2018 Shinichi TAMURA <shnch.tmr@gmail.com>                         #
# Copyright 2018 Steve Kowalik <steven@wedontsleep.org>                        #
# Copyright 2018 Thibault Jamet <tjamet@users.noreply.pygithub.com>              #
...
# Copyright 2019 Pavan Kunisetty <nagapavan@users.noreply.pygithub.com>          #
...
# Copyright 2023 Heitor Polidoro <14806300+heitorpolidoro@users.noreply.pygithub.com>#
...
# Copyright 2023 sd-kialo <138505487+sd-kialo@users.noreply.pygithub.com>        #
...
import pygithub.PullRequestReview
...
class PullRequest(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._assignee: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._assignees: Attribute[list[NamedUser]] = NotSet
        self._base: Attribute[pygithub.PullRequestPart.PullRequestPart] = NotSet
        ...
        self._head: Attribute[pygithub.PullRequestPart.PullRequestPart] = NotSet
        self._html_url: Attribute[str] = NotSet
        self._id: Attribute[int] = NotSet
        self._issue_url: Attribute[str] = NotSet
        self._labels: Attribute[list[pygithub.Label.Label]] = NotSet
        ...
        self._merged_by: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._milestone: Attribute[pygithub.Milestone.Milestone] = NotSet
        ...
        self._user: Attribute[pygithub.NamedUser.NamedUser] = NotSet
    ...
    @property
    def assignee(self) -> pygithub.NamedUser.NamedUser:
        self._completeIfNotSet(self._assignee)
        return self._assignee.value

    @property
    def assignees(self) -> list[pygithub.NamedUser.NamedUser]:
        self._completeIfNotSet(self._assignees)
        return self._assignees.value

    @property
    def base(self) -> pygithub.PullRequestPart.PullRequestPart:
    ...
    @property
    def head(self) -> pygithub.PullRequestPart.PullRequestPart:
    ...
    @property
    def labels(self) -> list[pygithub.Label.Label]:
    ...
    @property
    def merged_by(self) -> pygithub.NamedUser.NamedUser:
        self._completeIfNotSet(self._merged_by)
        return self._merged_by.value

    @property
    def milestone(self) -> pygithub.Milestone.Milestone:
    ...
    @property
    def requested_reviewers(self) -> list[pygithub.NamedUser.NamedUser]:
        self._completeIfNotSet(self._requested_reviewers)
        return self._requested_reviewers.value

    @property
    def requested_teams(self) -> list[pygithub.Team.Team]:
    ...
    def create_comment(
        self, body: str, commit: pygithub.Commit.Commit, path: str, position: int
    ...
    def create_review_comment(
        ...
        assert isinstance(commit, pygithub.Commit.Commit), commit
    ...
    def create_review_comment_reply(self, comment_id: int, body: str) -> pygithub.PullRequestComment.PullRequestComment:
        """
    ...
    def create_issue_comment(self, body: str) -> pygithub.IssueComment.IssueComment:
        """
    ...
    def create_review(
        self,
        commit: Opt[pygithub.Commit.Commit] = NotSet,
        body: Opt[str] = NotSet,
        event: Opt[str] = NotSet,
        comments: Opt[list[ReviewComment]] = NotSet,
    ) -> pygithub.PullRequestReview.PullRequestReview:
        """
        ...
        """
        assert is_optional(commit, pygithub.Commit.Commit), commit
        ...
        return pygithub.PullRequestReview.PullRequestReview(self._requester, headers, data, completed=True)
    ...
    def get_comment(self, id: int) -> pygithub.PullRequestComment.PullRequestComment:
        """
    ...
    def get_review_comment(self, id: int) -> pygithub.PullRequestComment.PullRequestComment:
        """
        :calls: `GET /repos/{owner}/{repo}/pulls/comments/{number} <https://docs.github.com/en/rest/reference/pulls#review-comments>`_
        """
    ...
    ) -> PaginatedList[pygithub.PullRequestComment.PullRequestComment]:
        """
    ...
    def get_single_review_comments(self, id: int) -> PaginatedList[pygithub.PullRequestComment.PullRequestComment]:
        """
    ...
    def get_commits(self) -> PaginatedList[pygithub.Commit.Commit]:
        """
        :calls: `GET /repos/{owner}/{repo}/pulls/{number}/commits <https://docs.github.com/en/rest/reference/pulls>`_
        """
        return PaginatedList(pygithub.Commit.Commit, self._requester, f"{self.url}/commits", None)

    def get_files(self) -> PaginatedList[pygithub.File.File]:
        """
        :calls: `GET /repos/{owner}/{repo}/pulls/{number}/files <https://docs.github.com/en/rest/reference/pulls>`_
        """
        return PaginatedList(pygithub.File.File, self._requester, f"{self.url}/files", None)

    def get_issue_comment(self, id: int) -> pygithub.IssueComment.IssueComment:
        """
    ...
    def get_issue_comments(self) -> PaginatedList[pygithub.IssueComment.IssueComment]:
        """
    ...
    def get_issue_events(self) -> PaginatedList[pygithub.IssueEvent.IssueEvent]:
        """
    ...
    def get_review(self, id: int) -> pygithub.PullRequestReview.PullRequestReview:
        """
    ...
    def get_reviews(self) -> PaginatedList[pygithub.PullRequestReview.PullRequestReview]:
        """
    ...
    def get_review_requests(self) -> tuple[PaginatedList[NamedUser], PaginatedList[pygithub.Team.Team]]:
        """
        ...
        :rtype: tuple of :class:`pygithub.PaginatedList.PaginatedList` of :class:`pygithub.NamedUser.NamedUser` and of :class:`pygithub.PaginatedList.PaginatedList` of :class:`pygithub.Team.Team`
        """
        return (
            PaginatedList(
    ...
    def get_labels(self) -> PaginatedList[pygithub.Label.Label]:
        """
        :calls: `GET /repos/{owner}/{repo}/issues/{number}/labels <https://docs.github.com/en/rest/reference/issues#labels>`_
        """
        return PaginatedList(pygithub.Label.Label, self._requester, f"{self.issue_url}/labels", None)

    def add_to_labels(self, *labels: pygithub.Label.Label | str) -> None:
        """
        :calls: `POST /repos/{owner}/{repo}/issues/{number}/labels <https://docs.github.com/en/rest/reference/issues#labels>`_
        """
        assert all(isinstance(element, (pygithub.Label.Label, str)) for element in labels), labels
    ...
    def remove_from_labels(self, label: pygithub.Label.Label | str) -> None:
        """
        :calls: `DELETE /repos/{owner}/{repo}/issues/{number}/labels/{name} <https://docs.github.com/en/rest/reference/issues#labels>`_
        """
        assert isinstance(label, (pygithub.Label.Label, str)), label
    ...
    def set_labels(self, *labels: pygithub.Label.Label | str) -> None:
        """
    ...
    def merge(
        ...
        sha: Opt[str] = NotSet,
    ) -> pygithub.PullRequestMergeStatus.PullRequestMergeStatus:
        """
    ...
    def add_to_assignees(self, *assignees: pygithub.NamedUser.NamedUser | str) -> None:
        """
        ...
        """
        assert all(isinstance(element, (pygithub.NamedUser.NamedUser, str)) for element in assignees), assignees
        post_parameters = {
            "assignees": [
                assignee.login if isinstance(assignee, pygithub.NamedUser.NamedUser) else assignee
    ...
    def remove_from_assignees(self, *assignees: pygithub.NamedUser.NamedUser | str) -> None:
        """
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "assignees" in attributes:  # pragma no branch
            self._assignees = self._makeListOfClassesAttribute(pygithub.NamedUser.NamedUser, attributes["assignees"])
        elif "assignee" in attributes:
            if attributes["assignee"] is not None:
                self._assignees = self._makeListOfClassesAttribute(pygithub.NamedUser.NamedUser, [attributes["assignee"]])
            else:
                self._assignees = self._makeListOfClassesAttribute(pygithub.NamedUser.NamedUser, [])
        ...
        if "requested_reviewers" in attributes:
            self._requested_reviewers = self._makeListOfClassesAttribute(
                pygithub.NamedUser.NamedUser, attributes["requested_reviewers"]
            )
        if "requested_teams" in attributes:
            self._requested_teams = self._makeListOfClassesAttribute(pygithub.Team.Team, attributes["requested_teams"])
