...
import pygithub.CheckRunAnnotation
import pygithub.CheckRunOutput
...
if TYPE_CHECKING:
    from pygithub.CheckRunAnnotation import CheckRunAnnotation
    from pygithub.CheckRunOutput import CheckRunOutput
...
class CheckRun(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._output: Attribute[pygithub.CheckRunOutput.CheckRunOutput] = NotSet
    ...
    def get_annotations(self) -> PaginatedList[CheckRunAnnotation]:
        ...
        return PaginatedList(
            pygithub.CheckRunAnnotation.CheckRunAnnotation,
            self._requester,
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "output" in attributes:  # pragma no branch
            self._output = self._makeClassAttribute(pygithub.CheckRunOutput.CheckRunOutput, attributes["output"])
