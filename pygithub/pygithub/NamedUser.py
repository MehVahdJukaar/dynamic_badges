...
# Copyright 2018 namc <namratachaudhary@users.noreply.pygithub.com>              #
...
from pygithub.GithubObject import Attribute, NotSet, Opt, is_defined
...
class NamedUser(pygithub.GithubObject.CompletableGithubObject):
    ...
    def get_events(self) -> PaginatedList[Event]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(pygithub.Event.Event, self._requester, f"{self.url}/events", None)
    ...
    def get_followers(self) -> PaginatedList[NamedUser]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(NamedUser, self._requester, f"{self.url}/followers", None)
    ...
    def get_following(self) -> PaginatedList[NamedUser]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(NamedUser, self._requester, f"{self.url}/following", None)
    ...
    def get_gists(self, since: Opt[datetime] = NotSet) -> PaginatedList[Gist]:
        ...
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Gist.Gist, self._requester, f"{self.url}/gists", url_parameters
        )
    ...
    def get_keys(self) -> PaginatedList[UserKey]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(pygithub.UserKey.UserKey, self._requester, f"{self.url}/keys", None)
    ...
    def get_orgs(self) -> PaginatedList[Organization]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Organization.Organization, self._requester, f"{self.url}/orgs", None
        )
    ...
    def get_public_events(self) -> PaginatedList[Event]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Event.Event, self._requester, f"{self.url}/events/public", None
        )
    ...
    def get_received_events(self) -> PaginatedList[Event]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Event.Event, self._requester, f"{self.url}/received_events", None
        )
    ...
    def get_starred(self) -> PaginatedList[Repository]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Repository.Repository, self._requester, f"{self.url}/starred", None
        )
    ...
    def get_watched(self) -> PaginatedList[Repository]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Repository.Repository, self._requester, f"{self.url}/watched", None
        )
    ...
    def get_organization_membership(self, org: str | Organization) -> Membership:
        ...
        """
        assert isinstance(org, str) or isinstance(org, pygithub.Organization.Organization), org
        if isinstance(org, pygithub.Organization.Organization):
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "inviter" in attributes:  # pragma no branch
            self._inviter = self._makeClassAttribute(pygithub.NamedUser.NamedUser, attributes["inviter"])
