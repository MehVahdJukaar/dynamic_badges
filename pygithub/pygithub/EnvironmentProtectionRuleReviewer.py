...
class EnvironmentProtectionRuleReviewer(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._reviewer: Attribute[pygithub.NamedUser.NamedUser | pygithub.Team.Team] = NotSet
    ...
    @property
    def reviewer(self) -> pygithub.NamedUser.NamedUser | pygithub.Team.Team:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "reviewer" in attributes:  # pragma no branch
            ...
            if self._type.value == "User":
                self._reviewer = self._makeClassAttribute(pygithub.NamedUser.NamedUser, attributes["reviewer"])
            elif self._type.value == "Team":
                self._reviewer = self._makeClassAttribute(pygithub.Team.Team, attributes["reviewer"])
