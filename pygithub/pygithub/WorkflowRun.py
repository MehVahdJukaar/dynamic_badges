...
# Copyright 2023 Sasha Chung <50770626+nuang-ee@users.noreply.pygithub.com>      #
...
if TYPE_CHECKING:
    ...
    from pygithub.WorkflowJob import WorkflowJob
...
class WorkflowRun(CompletableGithubObject):
    ...
    def jobs(self, _filter: Opt[str] = NotSet) -> PaginatedList[WorkflowJob]:
        ...
        return PaginatedList(
            pygithub.WorkflowJob.WorkflowJob,
            self._requester,
            self.jobs_url,
            url_parameters,
            list_item="jobs",
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "head_repository" in attributes:  # pragma no branch
            self._head_repository = self._makeClassAttribute(
                pygithub.Repository.Repository, attributes["head_repository"]
            )
