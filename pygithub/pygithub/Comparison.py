...
class Comparison(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._base_commit: Attribute[pygithub.Commit.Commit] = NotSet
        self._behind_by: Attribute[int] = NotSet
        self._diff_url: Attribute[str] = NotSet
        self._files: Attribute[list[pygithub.File.File]] = NotSet
        self._html_url: Attribute[str] = NotSet
        self._merge_base_commit: Attribute[pygithub.Commit.Commit] = NotSet
    ...
    @property
    def base_commit(self) -> pygithub.Commit.Commit:
    ...
    @property
    def commits(self) -> PaginatedList[pygithub.Commit.Commit]:
    ...
    @property
    def files(self) -> list[pygithub.File.File]:
    ...
    @property
    def merge_base_commit(self) -> pygithub.Commit.Commit:
