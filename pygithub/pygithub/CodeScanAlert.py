...
import pygithub.CodeScanAlertInstance
import pygithub.CodeScanRule
import pygithub.CodeScanTool
...
class CodeScanAlert(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._rule: Attribute[pygithub.CodeScanRule.CodeScanRule] = NotSet
        self._tool: Attribute[pygithub.CodeScanTool.CodeScanTool] = NotSet
        self._created_at: Attribute[datetime] = NotSet
        self._dismissed_at: Attribute[datetime | None] = NotSet
        self._dismissed_by: Attribute[pygithub.NamedUser.NamedUser | None] = NotSet
        self._dismissed_reason: Attribute[str | None] = NotSet
        self._url: Attribute[str] = NotSet
        self._html_url: Attribute[str] = NotSet
        self._instances_url: Attribute[str] = NotSet
        self._most_recent_instance: Attribute[pygithub.CodeScanAlertInstance.CodeScanAlertInstance] = NotSet
    ...
    @property
    def rule(self) -> pygithub.CodeScanRule.CodeScanRule:
        return self._rule.value

    @property
    def tool(self) -> pygithub.CodeScanTool.CodeScanTool:
    ...
    @property
    def dismissed_by(self) -> pygithub.NamedUser.NamedUser | None:
    ...
    @property
    def most_recent_instance(self) -> pygithub.CodeScanAlertInstance.CodeScanAlertInstance:
    ...
    def get_instances(self) -> PaginatedList[pygithub.CodeScanAlertInstance.CodeScanAlertInstance]:
        """
        :calls: `GET` on the URL for instances as provided by Github
        """
        return PaginatedList(
            pygithub.CodeScanAlertInstance.CodeScanAlertInstance,
            self._requester,
            self.instances_url,
            None,
        )
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "rule" in attributes:  # pragma no branch
            self._rule = self._makeClassAttribute(pygithub.CodeScanRule.CodeScanRule, attributes["rule"])
        if "tool" in attributes:  # pragma no branch
            self._tool = self._makeClassAttribute(pygithub.CodeScanTool.CodeScanTool, attributes["tool"])
        ...
        if "dismissed_by" in attributes:  # pragma no branch
            self._dismissed_by = self._makeClassAttribute(pygithub.NamedUser.NamedUser, attributes["dismissed_by"])
