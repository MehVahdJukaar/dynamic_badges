...
# Copyright 2015 Kyle Hornberg <khornberg@users.noreply.pygithub.com>            #
...
# Copyright 2016 Sylvus <Sylvus@users.noreply.pygithub.com>                      #
...
# Copyright 2017 Chris McBride <thehighlander@users.noreply.pygithub.com>        #
# Copyright 2017 Hugo <hugovk@users.noreply.pygithub.com>                        #
# Copyright 2017 Jannis Gebauer <ja.geb@me.com>                                #
# Copyright 2017 Jason White <jasonwhite@users.noreply.pygithub.com>             #
# Copyright 2017 Jimmy Zelinskie <jimmy.zelinskie+git@gmail.com>               #
# Copyright 2017 Simon <spam@esemi.ru>                                         #
# Copyright 2018 Aaron L. Levine <allevin@sandia.gov>                          #
# Copyright 2018 AetherDeity <aetherdeity+pygithub@gmail.com>                    #
...
# Copyright 2018 John Hui <j-hui@users.noreply.pygithub.com>                     #
...
# Copyright 2018 Nicholas Buse <NicholasBuse@users.noreply.pygithub.com>         #
# Copyright 2018 Philip May <eniak.info@gmail.com>                             #
# Copyright 2018 Raihaan <31362124+res0nance@users.noreply.pygithub.com>         #
# Copyright 2018 Shinichi TAMURA <shnch.tmr@gmail.com>                         #
# Copyright 2018 Steve Kowalik <steven@wedontsleep.org>                        #
# Copyright 2018 Vinay Hegde <hegde.vi@husky.neu.edu>                          #
# Copyright 2018 Wan Liuyang <tsfdye@gmail.com>                                #
# Copyright 2018 Will Yardley <wyardley@users.noreply.pygithub.com>              #
...
# Copyright 2019 Alex <alexmusa@users.noreply.pygithub.com>                      #
...
# Copyright 2020 Glenn McDonald <testworksau@users.noreply.pygithub.com>         #
...
# Copyright 2020 Victor Zeng <zacker150@users.noreply.pygithub.com>              #
...
# Copyright 2021 Tanner <51724788+lightningboltemoji@users.noreply.pygithub.com> #
...
# Copyright 2022 KimSia Sim <245021+simkimsia@users.noreply.pygithub.com>        #
# Copyright 2022 Marco Köpcke <hello@parakoopa.de>                             #
# Copyright 2023 Andrew Collington <andy@amnuts.com>                           #
# Copyright 2023 Andrew Dawes <53574062+AndrewJDawes@users.noreply.pygithub.com> #
# Copyright 2023 Armen Martirosyan <armartirosyan@gmail.com>                   #
# Copyright 2023 BradChengIRESS <49461141+BradChengIRESS@users.noreply.pygithub.com>#
...
# Copyright 2023 Jonathan Greg <31892308+jmgreg31@users.noreply.pygithub.com>    #
# Copyright 2023 Jonathan Leitschuh <jonathan.leitschuh@gmail.com>             #
# Copyright 2023 Joseph Henrich <crimsonknave@gmail.com>                       #
# Copyright 2023 Kevin Grandjean <Muscaw@users.noreply.pygithub.com>             #
...
# Copyright 2023 Max Mehl <6170081+mxmehl@users.noreply.pygithub.com>            #
# Copyright 2023 Micael <10292135+notmicaelfilipe@users.noreply.pygithub.com>    #
# Copyright 2023 Mikhail f. Shiryaev <mr.felixoid@gmail.com>                   #
# Copyright 2023 Oskar Jansson <56458534+janssonoskar@users.noreply.pygithub.com>#
# Copyright 2023 Philipp A <flying-sheep@web.de>                               #
# Copyright 2023 Roberto Pastor Muela <37798125+RobPasMue@users.noreply.pygithub.com>#
# Copyright 2023 Sol Redfern <59831933+Tsuesun@users.noreply.pygithub.com>       #
# Copyright 2023 Trim21 <trim21.me@gmail.com>                                  #
# Copyright 2023 Wojciech Barczyński <104033489+WojciechBarczynski@users.noreply.pygithub.com>#
# Copyright 2023 alson <git@alm.nufan.net>                                     #
# Copyright 2023 chantra <chantra@users.noreply.pygithub.com>                    #
# Copyright 2024 Enrico Minack <pygithub@enrico.minack.dev>                      #
...
import pygithub.AdvisoryCredit
import pygithub.AdvisoryVulnerability
import pygithub.Artifact
import pygithub.AuthenticatedUser
import pygithub.Autolink
import pygithub.Branch
import pygithub.CheckRun
import pygithub.CheckSuite
import pygithub.Clones
import pygithub.CodeScanAlert
import pygithub.Commit
import pygithub.CommitComment
import pygithub.Comparison
import pygithub.ContentFile
import pygithub.DependabotAlert
import pygithub.Deployment
import pygithub.Download
import pygithub.Environment
import pygithub.EnvironmentDeploymentBranchPolicy
import pygithub.EnvironmentProtectionRule
import pygithub.EnvironmentProtectionRuleReviewer
import pygithub.Event
import pygithub.GitBlob
import pygithub.GitCommit
import pygithub.GithubObject
import pygithub.GitRef
import pygithub.GitRelease
import pygithub.GitReleaseAsset
import pygithub.GitTag
import pygithub.GitTree
import pygithub.Hook
import pygithub.HookDelivery
import pygithub.Invitation
import pygithub.Issue
import pygithub.IssueComment
import pygithub.IssueEvent
import pygithub.Label
import pygithub.License
...
import pygithub.Path
import pygithub.Permissions
import pygithub.Project
import pygithub.PublicKey
import pygithub.PullRequest
import pygithub.PullRequestComment
import pygithub.Referrer
import pygithub.RepositoryAdvisory
import pygithub.RepositoryKey
import pygithub.RepositoryPreferences
import pygithub.Secret
import pygithub.SelfHostedActionsRunner
import pygithub.SourceImport
import pygithub.Stargazer
import pygithub.StatsCodeFrequency
import pygithub.StatsCommitActivity
import pygithub.StatsContributor
import pygithub.StatsParticipation
import pygithub.StatsPunchCard
import pygithub.Tag
import pygithub.Team
import pygithub.Variable
import pygithub.View
import pygithub.Workflow
import pygithub.WorkflowRun
from pygithub import Consts
from pygithub.Environment import Environment
from pygithub.GithubObject import (
    Attribute,
...
from pygithub.PaginatedList import PaginatedList

if TYPE_CHECKING:
    from pygithub.Artifact import Artifact
    from pygithub.AuthenticatedUser import AuthenticatedUser
    from pygithub.Autolink import Autolink
    from pygithub.Branch import Branch
    from pygithub.CheckRun import CheckRun
    from pygithub.CheckSuite import CheckSuite
    from pygithub.Clones import Clones
    from pygithub.CodeScanAlert import CodeScanAlert
    from pygithub.Commit import Commit
    from pygithub.CommitComment import CommitComment
    from pygithub.Comparison import Comparison
    from pygithub.ContentFile import ContentFile
    from pygithub.DependabotAlert import DependabotAlert
    from pygithub.Deployment import Deployment
    from pygithub.Download import Download
    from pygithub.EnvironmentDeploymentBranchPolicy import EnvironmentDeploymentBranchPolicyParams
    from pygithub.EnvironmentProtectionRuleReviewer import ReviewerParams
    from pygithub.Event import Event
    from pygithub.GitBlob import GitBlob
    from pygithub.GitCommit import GitCommit
    from pygithub.GitRef import GitRef
    from pygithub.GitRelease import GitRelease
    from pygithub.GitReleaseAsset import GitReleaseAsset
    from pygithub.GitTag import GitTag
    from pygithub.GitTree import GitTree
    from pygithub.Hook import Hook
    from pygithub.InputGitAuthor import InputGitAuthor
    from pygithub.InputGitTreeElement import InputGitTreeElement
    from pygithub.Invitation import Invitation
    from pygithub.Issue import Issue
    from pygithub.IssueComment import IssueComment
    from pygithub.IssueEvent import IssueEvent
    from pygithub.Label import Label
    from pygithub.License import License
    from pygithub.Milestone import Milestone
    from pygithub.NamedUser import NamedUser
    from pygithub.Notification import Notification
    from pygithub.Organization import Organization
    from pygithub.Path import Path
    from pygithub.Permissions import Permissions
    from pygithub.Project import Project
    from pygithub.PublicKey import PublicKey
    from pygithub.PullRequest import PullRequest
    from pygithub.PullRequestComment import PullRequestComment
    from pygithub.Referrer import Referrer
    from pygithub.RepositoryKey import RepositoryKey
    from pygithub.RepositoryPreferences import RepositoryPreferences
    from pygithub.SelfHostedActionsRunner import SelfHostedActionsRunner
    from pygithub.SourceImport import SourceImport
    from pygithub.Stargazer import Stargazer
    from pygithub.StatsCodeFrequency import StatsCodeFrequency
    from pygithub.StatsCommitActivity import StatsCommitActivity
    from pygithub.StatsContributor import StatsContributor
    from pygithub.StatsParticipation import StatsParticipation
    from pygithub.StatsPunchCard import StatsPunchCard
    from pygithub.Tag import Tag
    from pygithub.Team import Team
    from pygithub.View import View
    from pygithub.Workflow import Workflow
    from pygithub.WorkflowRun import WorkflowRun
...
class Repository(CompletableGithubObject):
    ...
    def permissions(self) -> Permissions:
        """
        :type: :class:`pygithub.Permissions.Permissions`
        """
    ...
    def add_to_collaborators(self, collaborator: str | NamedUser, permission: Opt[str] = NotSet) -> Invitation | None:
        ...
        :param collaborator: string or :class:`pygithub.NamedUser.NamedUser`
        :param permission: string 'pull', 'push', 'admin', 'maintain', or 'triage'
        :rtype: None
        """
        assert isinstance(collaborator, pygithub.NamedUser.NamedUser) or isinstance(collaborator, str), collaborator
        assert permission in ["pull", "push", "admin", "maintain", "triage", NotSet], permission

        if isinstance(collaborator, pygithub.NamedUser.NamedUser):
        ...
        return (
            pygithub.Invitation.Invitation(self._requester, headers, data, completed=True) if data is not None else None
        )
    ...
    def get_pending_invitations(self) -> PaginatedList[Invitation]:
        ...
        return PaginatedList(
            pygithub.Invitation.Invitation,
            self._requester,
    ...
    def compare(self, base: str, head: str) -> Comparison:
        ...
        return pygithub.Comparison.Comparison(self._requester, headers, data, completed=True)

    def create_autolink(
        self, key_prefix: str, url_template: str, is_alphanumeric: Opt[bool] = NotSet
    ) -> pygithub.Autolink.Autolink:
        """
        ...
        return pygithub.Autolink.Autolink(self._requester, headers, data, completed=True)
    ...
    def create_git_blob(self, content: str, encoding: str) -> GitBlob:
        ...
        return pygithub.GitBlob.GitBlob(self._requester, headers, data, completed=True)
    ...
    def create_git_commit(
        ...
        :param tree: :class:`pygithub.GitTree.GitTree`
        :param parents: list of :class:`pygithub.GitCommit.GitCommit`
        :param author: :class:`pygithub.InputGitAuthor.InputGitAuthor`
        :param committer: :class:`pygithub.InputGitAuthor.InputGitAuthor`
        :rtype: :class:`github.GitCommit.GitCommit`
        """
        assert isinstance(message, str), message
        assert isinstance(tree, pygithub.GitTree.GitTree), tree
        assert all(isinstance(element, pygithub.GitCommit.GitCommit) for element in parents), parents
        assert is_optional(author, pygithub.InputGitAuthor), author
        assert is_optional(committer, pygithub.InputGitAuthor), committer
        ...
        return pygithub.GitCommit.GitCommit(self._requester, headers, data, completed=True)
    ...
    def create_git_ref(self, ref: str, sha: str) -> GitRef:
        ...
        return pygithub.GitRef.GitRef(self._requester, headers, data, completed=True)
    ...
    def create_git_tag_and_release(
        ...
        :param object: string
        :param type: string
        :param tagger: :class:pygithub.InputGitAuthor.InputGitAuthor
        :param draft: bool
    ...
    def create_git_release(
        ...
        :param prerelease: bool
        :param generate_release_notes: bool
        :param target_commitish: string or :class:`pygithub.Branch.Branch` or :class:`pygithub.Commit.Commit` or :class:`pygithub.GitCommit.GitCommit`
        :rtype: :class:`github.GitRelease.GitRelease`
        """
        ...
        assert is_optional(
            target_commitish,
            (str, pygithub.Branch.Branch, pygithub.Commit.Commit, pygithub.GitCommit.GitCommit),
        ), target_commitish
        post_parameters = {
            "tag_name": tag,
            "name": name,
        ...
        elif isinstance(target_commitish, pygithub.Branch.Branch):
            post_parameters["target_commitish"] = target_commitish.name
        elif isinstance(target_commitish, (pygithub.Commit.Commit, pygithub.GitCommit.GitCommit)):
        ...
        return pygithub.GitRelease.GitRelease(self._requester, headers, data, completed=True)
    ...
    def create_git_tag(
        ...
        assert is_optional(tagger, pygithub.InputGitAuthor), tagger
        post_parameters: dict[str, Any] = {
            "tag": tag,
            "message": message,
            "object": object,
        ...
        return pygithub.GitTag.GitTag(self._requester, headers, data, completed=True)
    ...
    def create_git_tree(self, tree: list[InputGitTreeElement], base_tree: Opt[GitTree] = NotSet) -> GitTree:
        ...
        :param tree: list of :class:`pygithub.InputGitTreeElement.InputGitTreeElement`
        :param base_tree: :class:`pygithub.GitTree.GitTree`
        :rtype: :class:`github.GitTree.GitTree`
        """
        assert all(isinstance(element, pygithub.InputGitTreeElement) for element in tree), tree
        assert is_optional(base_tree, pygithub.GitTree.GitTree), base_tree
        post_parameters: dict[str, Any] = {
        ...
        return pygithub.GitTree.GitTree(self._requester, headers, data, completed=True)
    ...
    def create_hook(
        ...
        return pygithub.Hook.Hook(self._requester, headers, data, completed=True)
    ...
    def create_issue(
        ...
        :param title: string
        :param body: string
        :param assignee: string or :class:`pygithub.NamedUser.NamedUser`
        :param assignees: list of string or :class:`pygithub.NamedUser.NamedUser`
        :param milestone: :class:`pygithub.Milestone.Milestone`
        :param labels: list of :class:`pygithub.Label.Label`
        :rtype: :class:`github.Issue.Issue`
        """
        assert isinstance(title, str), title
        assert is_optional(body, str), body
        assert is_optional(assignee, (str, pygithub.NamedUser.NamedUser)), assignee
        assert is_optional_list(assignees, (pygithub.NamedUser.NamedUser, str)), assignees
        assert is_optional(milestone, pygithub.Milestone.Milestone), milestone
        assert is_optional_list(labels, (pygithub.Label.Label, str)), labels
        ...
        if is_defined(assignee):
            if isinstance(assignee, pygithub.NamedUser.NamedUser):
                post_parameters["assignee"] = assignee._identity
            else:
                post_parameters["assignee"] = assignee
        if is_defined(assignees):
            post_parameters["assignees"] = [
                element._identity if isinstance(element, pygithub.NamedUser.NamedUser) else element
        ...
        if is_defined(labels):
            post_parameters["labels"] = [
                element.name if isinstance(element, pygithub.Label.Label) else element
        ...
        return pygithub.Issue.Issue(self._requester, headers, data, completed=True)
    ...
    def create_key(self, title: str, key: str, read_only: bool = False) -> RepositoryKey:
        ...
        return pygithub.RepositoryKey.RepositoryKey(self._requester, headers, data, completed=True)
    ...
    def create_label(self, name: str, color: str, description: Opt[str] = NotSet) -> Label:
        ...
        return pygithub.Label.Label(self._requester, headers, data, completed=True)
    ...
    def create_milestone(
        ...
        return pygithub.Milestone.Milestone(self._requester, headers, data, completed=True)
    ...
    def create_project(self, name: str, body: Opt[str] = NotSet) -> Project:
        ...
        return pygithub.Project.Project(self._requester, headers, data, completed=True)
    ...
    def create_pull(
        ...
        *,
        ...
        issue: Opt[pygithub.Issue.Issue] = NotSet,
    ) -> pygithub.PullRequest.PullRequest:
        """
        ...
        assert is_optional(issue, pygithub.Issue.Issue), issue
        ...
        return pygithub.PullRequest.PullRequest(self._requester, headers, data, completed=True)
    ...
    def create_repository_advisory(
        ...
        vulnerabilities: Iterable[pygithub.AdvisoryVulnerability.AdvisoryVulnerabilityInput] | None = None,
        cwe_ids: Iterable[str] | None = None,
        credits: Iterable[pygithub.AdvisoryCredit.AdvisoryCredit] | None = None,
    ) -> pygithub.RepositoryAdvisory.RepositoryAdvisory:
        """
        ...
        :param cve_id: string
        :param vulnerabilities: iterable of :class:`pygithub.AdvisoryVulnerability.AdvisoryVulnerabilityInput`
        :param cwe_ids: iterable of string
        :param credits: iterable of :class:`pygithub.AdvisoryCredit.AdvisoryCredit`
    ...
    def __create_repository_advisory(
        ...
        severity_or_cvss_vector_string: str,
        cve_id: str | None,
        vulnerabilities: Iterable[pygithub.AdvisoryVulnerability.AdvisoryVulnerabilityInput] | None,
        cwe_ids: Iterable[str] | None,
        credits: Iterable[pygithub.AdvisoryCredit.AdvisoryCredit] | None,
        ...
        for vulnerability in vulnerabilities:
            pygithub.AdvisoryVulnerability.AdvisoryVulnerability._validate_vulnerability(vulnerability)
        ...
        if credits is not None:
            for credit in credits:
                pygithub.AdvisoryCredit.AdvisoryCredit._validate_credit(credit)
        post_parameters = {
            "summary": summary,
            "description": description,
            "vulnerabilities": [
                pygithub.AdvisoryVulnerability.AdvisoryVulnerability._to_github_dict(vulnerability)
                for vulnerability in vulnerabilities
            ],
        ...
        if credits is not None:
            post_parameters["credits"] = [
                pygithub.AdvisoryCredit.AdvisoryCredit._to_github_dict(credit) for credit in credits
            ]
        ...
        return pygithub.RepositoryAdvisory.RepositoryAdvisory(self._requester, headers, data, completed=True)
    ...
    def create_secret(self, secret_name: str, unencrypted_value: str) -> pygithub.Secret.Secret:
        """
    ...
    def get_secrets(self) -> PaginatedList[pygithub.Secret.Secret]:
        """
        Gets all repository secrets
        """
        return PaginatedList(
            pygithub.Secret.Secret,
            self._requester,
    ...
    def get_secret(self, secret_name: str) -> pygithub.Secret.Secret:
        """
    ...
    def create_variable(self, variable_name: str, value: str) -> pygithub.Variable.Variable:
        """
        ...
        return pygithub.Variable.Variable(
            self._requester,
            headers={},
            attributes={
                "name": variable_name,
    ...
    def get_variables(self) -> PaginatedList[pygithub.Variable.Variable]:
        """
        Gets all repository variables
        :rtype: :class:`PaginatedList` of :class:`github.Variable.Variable`
        """
        return PaginatedList(
            pygithub.Variable.Variable,
            self._requester,
    ...
    def get_variable(self, variable_name: str) -> pygithub.Variable.Variable:
        """
    ...
    def create_source_import(
        ...
        return pygithub.SourceImport.SourceImport(self._requester, headers, data, completed=False)
    ...
    def get_assignees(self) -> PaginatedList[NamedUser]:
        ...
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, f"{self.url}/assignees", None)
    ...
    def get_branch(self, branch: str) -> Branch:
        ...
        return pygithub.Branch.Branch(self._requester, headers, data, completed=True)
    ...
    def rename_branch(self, branch: str | Branch, new_name: str) -> bool:
        ...
        :param branch: :class:`pygithub.Branch.Branch` or string
        ...
        """
        is_branch = isinstance(branch, pygithub.Branch.Branch)
    ...
    def get_branches(self) -> PaginatedList[Branch]:
        ...
        """
        return PaginatedList(pygithub.Branch.Branch, self._requester, f"{self.url}/branches", None)
    ...
    def get_commit(self, sha: str) -> Commit:
        ...
        return pygithub.Commit.Commit(self._requester, headers, data, completed=True)
    ...
    def get_commits(
        ...
        :param author: string or :class:`pygithub.NamedUser.NamedUser` or :class:`pygithub.AuthenticatedUser.AuthenticatedUser`
        ...
        assert is_optional(
            author,
            (str, pygithub.NamedUser.NamedUser, pygithub.AuthenticatedUser.AuthenticatedUser),
        ), author
        ...
        if is_defined(author):
            if isinstance(
                author,
                (pygithub.NamedUser.NamedUser, pygithub.AuthenticatedUser.AuthenticatedUser),
            ):
                url_parameters["author"] = author.login
            else:
                url_parameters["author"] = author
        return PaginatedList(pygithub.Commit.Commit, self._requester, f"{self.url}/commits", url_parameters)
    ...
    def get_contents(self, path: str, ref: Opt[str] = NotSet) -> list[ContentFile] | ContentFile:
        ...
        :param path: string
        :param ref: string
        :rtype: :class:`pygithub.ContentFile.ContentFile` or a list of them
        """
        ...
        if isinstance(data, list):
            return [
                ...
                pygithub.ContentFile.ContentFile(self._requester, headers, item, completed=(item["type"] != "file"))
                for item in data
            ]
        return pygithub.ContentFile.ContentFile(self._requester, headers, data, completed=True)
    ...
    def get_deployments(
        ...
        return PaginatedList(
            pygithub.Deployment.Deployment,
            self._requester,
    ...
    def get_deployment(self, id_: int) -> Deployment:
        ...
        return pygithub.Deployment.Deployment(self._requester, headers, data, completed=True)
    ...
    def get_top_referrers(self) -> None | list[Referrer]:
        ...
        if isinstance(data, list):
            return [pygithub.Referrer.Referrer(self._requester, headers, item, completed=True) for item in data]
    ...
    def get_top_paths(self) -> None | list[Path]:
        ...
        if isinstance(data, list):
            return [pygithub.Path.Path(self._requester, headers, item, completed=True) for item in data]
    ...
    def get_views_traffic(self, per: Opt[str] = NotSet) -> None | dict[str, int | list[View]]:
        ...
        if (isinstance(data, dict)) and ("views" in data) and (isinstance(data["views"], list)):
            data["views"] = [pygithub.View.View(self._requester, headers, item, completed=True) for item in data["views"]]
            return data
    ...
    def get_clones_traffic(self, per: Opt[str] = NotSet) -> dict[str, int | list[Clones]] | None:
        ...
        if (isinstance(data, dict)) and ("clones" in data) and (isinstance(data["clones"], list)):
            data["clones"] = [
                pygithub.Clones.Clones(self._requester, headers, item, completed=True) for item in data["clones"]
            ]
            return data
    ...
    def get_autolinks(self) -> PaginatedList[Autolink]:
        ...
        """
        return PaginatedList(pygithub.Autolink.Autolink, self._requester, f"{self.url}/autolinks", None)
    ...
    def create_file(
        ...
        :rtype: {
            'content': :class:`ContentFile <pygithub.ContentFile.ContentFile>`:,
            'commit': :class:`Commit <pygithub.Commit.Commit>`}
        """
        assert isinstance(path, str)
        assert isinstance(message, str)
        assert isinstance(content, (str, bytes))
        assert is_optional(branch, str)
        assert is_optional(author, pygithub.InputGitAuthor)
        assert is_optional(committer, pygithub.InputGitAuthor)
        ...
        return {
            "content": pygithub.ContentFile.ContentFile(self._requester, headers, data["content"], completed=False),
            "commit": pygithub.Commit.Commit(self._requester, headers, data["commit"], completed=True),
        }

    def get_repository_advisories(
        self,
    ) -> PaginatedList[pygithub.RepositoryAdvisory.RepositoryAdvisory]:
        """
    ...
    def get_repository_advisory(self, ghsa: str) -> pygithub.RepositoryAdvisory.RepositoryAdvisory:
        """
    ...
    def delete_file(
        ...
        assert is_optional(author, pygithub.InputGitAuthor), "author must be a pygithub.InputGitAuthor object"
        assert is_optional(committer, pygithub.InputGitAuthor), "committer must be a pygithub.InputGitAuthor object"
    ...
    def get_download(self, id: int) -> Download:
        ...
        return pygithub.Download.Download(self._requester, headers, data, completed=True)
    ...
    def get_downloads(self) -> PaginatedList[Download]:
        ...
        """
        return PaginatedList(pygithub.Download.Download, self._requester, f"{self.url}/downloads", None)
    ...
    def get_events(self) -> PaginatedList[Event]:
        ...
        """
        return PaginatedList(pygithub.Event.Event, self._requester, f"{self.url}/events", None)
    ...
    def create_fork(
        ...
        :param organization: :class:`pygithub.Organization.Organization` or string
        :param name: string
        :param default_branch_only: bool
        :rtype: :class:`github.Repository.Repository`
        """
        post_parameters: dict[str, Any] = {}
        if isinstance(organization, pygithub.Organization.Organization):
    ...
    def get_git_refs(self) -> PaginatedList[GitRef]:
        ...
        """
        return PaginatedList(pygithub.GitRef.GitRef, self._requester, f"{self.url}/git/refs", None)
    ...
    def get_hooks(self) -> PaginatedList[Hook]:
        ...
        """
        return PaginatedList(pygithub.Hook.Hook, self._requester, f"{self.url}/hooks", None)

    def get_hook_delivery(self, hook_id: int, delivery_id: int) -> pygithub.HookDelivery.HookDelivery:
        """
        ...
        return pygithub.HookDelivery.HookDelivery(self._requester, headers, data, completed=True)

    def get_hook_deliveries(self, hook_id: int) -> PaginatedList[pygithub.HookDelivery.HookDeliverySummary]:
        """
        ...
        return PaginatedList(
            pygithub.HookDelivery.HookDeliverySummary,
            self._requester,
    ...
    def get_issues(
        ...
        :param milestone: :class:`pygithub.Milestone.Milestone` or "none" or "*"
        ...
        :param assignee: string or :class:`pygithub.NamedUser.NamedUser` or "none" or "*"
        :param mentioned: :class:`pygithub.NamedUser.NamedUser`
        :param labels: list of string or :class:`pygithub.Label.Label`
        :param sort: string
        :param direction: string
        :param since: datetime
        :param creator: string or :class:`pygithub.NamedUser.NamedUser`
        :rtype: :class:`PaginatedList` of :class:`github.Issue.Issue`
        """
        assert milestone in ["*", "none", NotSet] or isinstance(milestone, pygithub.Milestone.Milestone), milestone
        assert is_optional(state, str), state
        assert is_optional(assignee, (str, pygithub.NamedUser.NamedUser)), assignee
        assert is_optional(mentioned, pygithub.NamedUser.NamedUser), mentioned
        assert is_optional_list(labels, (pygithub.Label.Label, str)), labels
        assert is_optional(sort, str), sort
        assert is_optional(direction, str), direction
        assert is_optional(since, datetime), since
        assert is_optional(creator, (str, pygithub.NamedUser.NamedUser)), creator
        url_parameters: dict[str, Any] = {}
        if is_defined(milestone):
            if isinstance(milestone, pygithub.Milestone.Milestone):
        ...
        if is_defined(labels):
            url_parameters["labels"] = ",".join(
                [label.name if isinstance(label, pygithub.Label.Label) else label for label in labels]  # type: ignore
            )
        if is_defined(sort):
        ...
        return PaginatedList(pygithub.Issue.Issue, self._requester, f"{self.url}/issues", url_parameters)
    ...
    def get_issues_event(self, id: int) -> IssueEvent:
        ...
        :param id: integer
        :rtype: :class:`pygithub.IssueEvent.IssueEvent`
        """
        assert isinstance(id, int), id
        headers, data = self._requester.requestJsonAndCheck(
            "GET",
        ...
        return pygithub.IssueEvent.IssueEvent(self._requester, headers, data, completed=True)
    ...
    def get_issues_events(self) -> PaginatedList[IssueEvent]:
        ...
        :rtype: :class:`PaginatedList` of :class:`pygithub.IssueEvent.IssueEvent`
        """
        return PaginatedList(
    ...
    def get_keys(self) -> PaginatedList[RepositoryKey]:
        ...
        """
        return PaginatedList(
            pygithub.RepositoryKey.RepositoryKey,
            self._requester,
            f"{self.url}/keys",
            None,
        )
    ...
    def get_labels(self) -> PaginatedList[Label]:
        ...
        """
        return PaginatedList(pygithub.Label.Label, self._requester, f"{self.url}/labels", None)
    ...
    def get_public_key(self) -> PublicKey:
        ...
        return pygithub.PublicKey.PublicKey(self._requester, headers, data, completed=True)
    ...
    def get_self_hosted_runner(self, runner_id: int) -> SelfHostedActionsRunner:
        ...
        return pygithub.SelfHostedActionsRunner.SelfHostedActionsRunner(self._requester, headers, data, completed=True)
    ...
    def get_self_hosted_runners(self) -> PaginatedList[SelfHostedActionsRunner]:
        ...
        """
        return PaginatedList(
            pygithub.SelfHostedActionsRunner.SelfHostedActionsRunner,
            self._requester,
    ...
    def get_source_import(self) -> SourceImport | None:
        ...
        if not data:
            ...
            return pygithub.SourceImport.SourceImport(self._requester, headers, data, completed=True)
    ...
    def get_stargazers(self) -> PaginatedList[NamedUser]:
        ...
        :rtype: :class:`PaginatedList` of :class:`github.NamedUser.NamedUser`
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, f"{self.url}/stargazers", None)
    ...
    def get_stats_contributors(self) -> list[StatsContributor] | None:
        ...
        if not data:
            ...
            return [
                pygithub.StatsContributor.StatsContributor(self._requester, headers, attributes, completed=True)
    ...
    def get_stats_commit_activity(self) -> list[StatsCommitActivity] | None:
        ...
        if not data:
            ...
            return [
                pygithub.StatsCommitActivity.StatsCommitActivity(self._requester, headers, attributes, completed=True)
                for attributes in data
            ]
    ...
    def get_stats_code_frequency(self) -> list[StatsCodeFrequency] | None:
        ...
        if not data:
            ...
            return [
                pygithub.StatsCodeFrequency.StatsCodeFrequency(self._requester, headers, attributes, completed=True)
                for attributes in data
            ]
    ...
    def get_stats_participation(self) -> StatsParticipation | None:
        ...
        if not data:
            ...
            return pygithub.StatsParticipation.StatsParticipation(self._requester, headers, data, completed=True)
    ...
    def get_stats_punch_card(self) -> StatsPunchCard | None:
        ...
        if not data:
            ...
            return pygithub.StatsPunchCard.StatsPunchCard(self._requester, headers, data, completed=True)
    ...
    def get_subscribers(self) -> PaginatedList[NamedUser]:
        ...
        :rtype: :class:`PaginatedList` of :class:`github.NamedUser.NamedUser`
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, f"{self.url}/subscribers", None)
    ...
    def get_tags(self) -> PaginatedList[Tag]:
        ...
        """
        return PaginatedList(pygithub.Tag.Tag, self._requester, f"{self.url}/tags", None)
    ...
    def get_releases(self) -> PaginatedList[GitRelease]:
        ...
        """
        return PaginatedList(pygithub.GitRelease.GitRelease, self._requester, f"{self.url}/releases", None)
    ...
    def get_teams(self) -> PaginatedList[Team]:
        ...
        """
        return PaginatedList(pygithub.Team.Team, self._requester, f"{self.url}/teams", None)
    ...
    def get_watchers(self) -> PaginatedList[NamedUser]:
        ...
        :rtype: :class:`PaginatedList` of :class:`github.NamedUser.NamedUser`
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, f"{self.url}/watchers", None)
    ...
    def get_workflow(self, id_or_file_name: str | int) -> Workflow:
        ...
        return pygithub.Workflow.Workflow(self._requester, headers, data, completed=True)
    ...
    def get_workflow_runs(
        ...
        :param actor: :class:`pygithub.NamedUser.NamedUser` or string
        :param branch: :class:`pygithub.Branch.Branch` or string
        :param event: string
        ...
        """
        assert is_optional(actor, (pygithub.NamedUser.NamedUser, str)), actor
        assert is_optional(branch, (pygithub.Branch.Branch, str)), branch
        ...
        url_parameters: dict[str, Any] = {}
        if is_defined(actor):
            if isinstance(actor, pygithub.NamedUser.NamedUser):
                url_parameters["actor"] = actor._identity
            else:
                url_parameters["actor"] = actor
        if is_defined(branch):
            if isinstance(branch, pygithub.Branch.Branch):
        ...
        return PaginatedList(
            pygithub.WorkflowRun.WorkflowRun,
            self._requester,
    ...
    def get_workflow_run(self, id_: int) -> WorkflowRun:
        ...
        return pygithub.WorkflowRun.WorkflowRun(self._requester, headers, data, completed=True)
    ...
    def has_in_assignees(self, assignee: str | NamedUser) -> bool:
        ...
        :rtype: bool
        """
        assert isinstance(assignee, pygithub.NamedUser.NamedUser) or isinstance(assignee, str), assignee
    ...
    def legacy_search_issues(self, state: str, keyword: str) -> list[Issue]:
        ...
        :rtype: List of :class:`pygithub.Issue.Issue`
        """
    ...
    def remove_self_hosted_runner(self, runner: SelfHostedActionsRunner | int) -> bool:
        ...
        :param runner: int or :class:`pygithub.SelfHostedActionsRunner.SelfHostedActionsRunner`
        :rtype: bool
        """
        assert isinstance(runner, pygithub.SelfHostedActionsRunner.SelfHostedActionsRunner) or isinstance(
            runner, int
        ), runner

        if isinstance(runner, pygithub.SelfHostedActionsRunner.SelfHostedActionsRunner):
            runner = runner.id
    ...
    def remove_autolink(self, autolink: Autolink | int) -> bool:
        ...
        :param autolink: int or :class:`pygithub.Autolink.Autolink`
        :rtype: None
        """
        is_autolink = isinstance(autolink, pygithub.Autolink.Autolink)
    ...
    def create_check_suite(self, head_sha: str) -> CheckSuite:
        ...
        return pygithub.CheckSuite.CheckSuite(self._requester, headers, data, completed=True)
    ...
    def get_check_suite(self, check_suite_id: int) -> CheckSuite:
        ...
        requestHeaders = {"Accept": "application/vnd.pygithub.v3+json"}
        headers, data = self._requester.requestJsonAndCheck(
            "GET",
    ...
    def update_check_suites_preferences(
        ...
        return pygithub.RepositoryPreferences.RepositoryPreferences(self._requester, headers, data, completed=True)
    ...
    def get_release_asset(self, id: int) -> GitReleaseAsset:
        ...
        return pygithub.GitReleaseAsset.GitReleaseAsset(self._requester, resp_headers, data, completed=True)
    ...
    def create_check_run(
        ...
        return pygithub.CheckRun.CheckRun(self._requester, headers, data, completed=True)
    ...
    def get_artifact(self, artifact_id: int) -> Artifact:
        ...
        return pygithub.Artifact.Artifact(self._requester, headers, data, completed=True)
    ...
    def get_codescan_alerts(self) -> PaginatedList[CodeScanAlert]:
        ...
        """
        return PaginatedList(
            pygithub.CodeScanAlert.CodeScanAlert,
            self._requester,
    ...
    def create_environment(
        ...
        :param reviews: List[:class:pygithub.EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams]
        :param deployment_branch_policy: Optional[:class:pygithub.EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams`]
        :rtype: :class:`github.Environment.Environment`
        """
        assert isinstance(environment_name, str), environment_name
        ...
        assert all(
            [isinstance(reviewer, pygithub.EnvironmentProtectionRuleReviewer.ReviewerParams) for reviewer in reviewers]
        )
        assert (
            isinstance(
                deployment_branch_policy,
                pygithub.EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicyParams,
            )
    ...
    def get_dependabot_alerts(
        ...
        return PaginatedList(
            pygithub.DependabotAlert.DependabotAlert,
            self._requester,
    ...
    def get_dependabot_alert(self, number: int) -> DependabotAlert:
        ...
        return pygithub.DependabotAlert.DependabotAlert(self._requester, headers, data, completed=True)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "license" in attributes:  # pragma no branch
            self._license = self._makeClassAttribute(pygithub.License.License, attributes["license"])
        ...
        if "organization" in attributes:  # pragma no branch
            self._organization = self._makeClassAttribute(pygithub.Organization.Organization, attributes["organization"])
        ...
        if "permissions" in attributes:  # pragma no branch
            self._permissions = self._makeClassAttribute(pygithub.Permissions.Permissions, attributes["permissions"])
