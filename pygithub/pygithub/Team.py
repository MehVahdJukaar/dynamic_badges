...
# Copyright 2020 Tal Machani <12785464+talmachani@users.noreply.pygithub.com>    #
...
import pygithub.TeamDiscussion
from pygithub import Consts
from pygithub.GithubException import UnknownObjectException
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet, Opt
...
if TYPE_CHECKING:
    ...
    from pygithub.TeamDiscussion import TeamDiscussion
...
class Team(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._organization: Attribute[pygithub.Organization.Organization] = NotSet
        self._privacy: Attribute[str] = NotSet
        self._parent: Attribute[pygithub.Team.Team] = NotSet
    ...
    def get_team_membership(self, member: str | NamedUser) -> Membership:
        ...
        """
        assert isinstance(member, str) or isinstance(member, pygithub.NamedUser.NamedUser), member
        if isinstance(member, pygithub.NamedUser.NamedUser):
    ...
    def get_repo_permission(self, repo: Repository) -> Permissions | None:
        ...
        """
        assert isinstance(repo, pygithub.Repository.Repository) or isinstance(repo, str), repo
        if isinstance(repo, pygithub.Repository.Repository):
        ...
        try:
            ...
            return pygithub.Permissions.Permissions(self._requester, headers, data["permissions"], completed=True)
    ...
    def get_discussions(self) -> PaginatedList[TeamDiscussion]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.TeamDiscussion.TeamDiscussion,
            self._requester,
    ...
    def get_repos(self) -> PaginatedList[Repository]:
        ...
        """
        return pygithub.PaginatedList.PaginatedList(
            pygithub.Repository.Repository, self._requester, f"{self.url}/repos", None
        )
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "parent" in attributes:  # pragma no branch
            self._parent = self._makeClassAttribute(pygithub.Team.Team, attributes["parent"])
