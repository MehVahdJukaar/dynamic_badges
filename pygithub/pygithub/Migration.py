...
class Migration(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._repositories: Attribute[list[pygithub.Repository.Repository]] = NotSet
    ...
    @property
    def repositories(self) -> list[pygithub.Repository.Repository]:
        self._completeIfNotSet(self._repositories)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "repositories" in attributes:
            self._repositories = self._makeListOfClassesAttribute(
                pygithub.Repository.Repository, attributes["repositories"]
            )
