...
# Copyright 2018 edquist <edquist@users.noreply.pygithub.com>                    #
...
class GitRelease(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._author: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        ...
        self._assets: Attribute[list[pygithub.GitReleaseAsset.GitReleaseAsset]] = NotSet
    ...
    @property
    def author(self) -> pygithub.NamedUser.NamedUser:
    ...
    @property
    def assets(self) -> list[pygithub.GitReleaseAsset.GitReleaseAsset]:
    ...
    ) -> pygithub.GitReleaseAsset.GitReleaseAsset:
        """
    ...
    def get_assets(self) -> PaginatedList[pygithub.GitReleaseAsset.GitReleaseAsset]:
        """
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "assets" in attributes:
            self._assets = self._makeListOfClassesAttribute(
                pygithub.GitReleaseAsset.GitReleaseAsset, attributes["assets"]
            )
