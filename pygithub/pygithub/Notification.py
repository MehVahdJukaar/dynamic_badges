...
class Notification(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._repository: Attribute[pygithub.Repository.Repository] = NotSet
        self._subject: Attribute[pygithub.NotificationSubject.NotificationSubject] = NotSet
    ...
    @property
    def repository(self) -> pygithub.Repository.Repository:
        self._completeIfNotSet(self._repository)
        return self._repository.value

    @property
    def subject(self) -> pygithub.NotificationSubject.NotificationSubject:
    ...
    def get_pull_request(self) -> pygithub.PullRequest.PullRequest:
    ...
    def get_issue(self) -> pygithub.Issue.Issue:
        headers, data = self._requester.requestJsonAndCheck("GET", self.subject.url)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "subject" in attributes:  # pragma no branch
            self._subject = self._makeClassAttribute(
                pygithub.NotificationSubject.NotificationSubject, attributes["subject"]
            )
