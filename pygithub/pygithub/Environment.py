...
from pygithub.Secret import Secret
from pygithub.Variable import Variable

if TYPE_CHECKING:
    from pygithub.EnvironmentDeploymentBranchPolicy import EnvironmentDeploymentBranchPolicy
    from pygithub.EnvironmentProtectionRule import EnvironmentProtectionRule
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "protection_rules" in attributes:  # pragma no branch
            self._protection_rules = self._makeListOfClassesAttribute(
                pygithub.EnvironmentProtectionRule.EnvironmentProtectionRule,
        ...
        if "deployment_branch_policy" in attributes:  # pragma no branch
            self._deployment_branch_policy = self._makeClassAttribute(
                pygithub.EnvironmentDeploymentBranchPolicy.EnvironmentDeploymentBranchPolicy,
