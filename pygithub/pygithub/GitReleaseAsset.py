...
class GitReleaseAsset(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._uploader: Attribute[pygithub.NamedUser.NamedUser] = NotSet
    ...
    @property
    def uploader(self) -> pygithub.NamedUser.NamedUser:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "uploader" in attributes:  # pragma no branch
            self._uploader = self._makeClassAttribute(pygithub.NamedUser.NamedUser, attributes["uploader"])
