...
# Copyright 2023 Nevins <nevins-b@users.noreply.pygithub.com>                    #
...
import pygithub.Consts
import pygithub.DeploymentStatus
...
class Deployment(CompletableGithubObject):
    ...
    def get_statuses(self) -> PaginatedList[pygithub.DeploymentStatus.DeploymentStatus]:
        """
        ...
        return PaginatedList(
            pygithub.DeploymentStatus.DeploymentStatus,
            self._requester,
            f"{self.url}/statuses",
            None,
    ...
    def get_status(self, id_: int) -> pygithub.DeploymentStatus.DeploymentStatus:
        """
        ...
        return pygithub.DeploymentStatus.DeploymentStatus(self._requester, headers, data, completed=True)
    ...
    def _get_accept_header() -> str:
        return ", ".join(
            [
                pygithub.Consts.deploymentEnhancementsPreview,
                pygithub.Consts.deploymentStatusEnhancementsPreview,
            ]
        )
