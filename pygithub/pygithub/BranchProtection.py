...
class BranchProtection(pygithub.GithubObject.CompletableGithubObject):
    """
    ...
    def _initAttributes(self) -> None:
        ...
        self._required_linear_history: Attribute[bool] = pygithub.GithubObject.NotSet
    ...
    def get_team_push_restrictions(self) -> PaginatedList[Team] | None:
        if not is_defined(self._team_push_restrictions):
            return None
        return pygithub.PaginatedList.PaginatedList(pygithub.Team.Team, self._requester, self._team_push_restrictions, None)
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "required_status_checks" in attributes:  # pragma no branch
            self._required_status_checks = self._makeClassAttribute(
                pygithub.RequiredStatusChecks.RequiredStatusChecks,
        ...
        if "required_pull_request_reviews" in attributes:  # pragma no branch
            self._required_pull_request_reviews = self._makeClassAttribute(
                pygithub.RequiredPullRequestReviews.RequiredPullRequestReviews,
