...
# Copyright 2018 Jess Morgan <979404+JessMorgan@users.noreply.pygithub.com>      #
...
class PullRequestComment(CompletableGithubObject):
    ...
    def get_reactions(self) -> PaginatedList[pygithub.Reaction.Reaction]:
        """
        ...
        :return: :class: :class:`pygithub.PaginatedList.PaginatedList` of :class:`pygithub.Reaction.Reaction`
        """
    ...
    def create_reaction(self, reaction_type: str) -> pygithub.Reaction.Reaction:
        """
