...
from pygithub.GistFile import GistFile
...
class GistHistoryState(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._change_status: Attribute[pygithub.CommitStats.CommitStats] = NotSet
        ...
        self._forks: Attribute[list[pygithub.Gist.Gist]] = NotSet
    ...
    @property
    def change_status(self) -> pygithub.CommitStats.CommitStats:
    ...
    @property
    def forks(self) -> list[pygithub.Gist.Gist]:
