...
from pygithub.Requester import Requester, WithRequester
...
# add new implementations of pygithub.Auth.Auth to docs/utilities.rst
class Auth(abc.ABC):
    """
...
class AppAuth(JWT):
    ...
    def get_installation_auth(
        ...
        """
        Creates a pygithub.Auth.AppInstallationAuth instance for an installation.
