...
class Event(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._org: Attribute[pygithub.Organization.Organization] = NotSet
        self._payload: Attribute[dict[str, Any]] = NotSet
        self._public: Attribute[bool] = NotSet
        self._repo: Attribute[pygithub.Repository.Repository] = NotSet
    ...
    @property
    def org(self) -> pygithub.Organization.Organization:
    ...
    @property
    def repo(self) -> pygithub.Repository.Repository:
