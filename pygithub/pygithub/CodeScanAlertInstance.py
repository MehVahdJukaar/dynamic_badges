...
import pygithub.CodeScanAlertInstanceLocation
from pygithub.GithubObject import Attribute, NonCompletableGithubObject, NotSet

if TYPE_CHECKING:
    from pygithub.CodeScanAlertInstanceLocation import CodeScanAlertInstanceLocation
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "location" in attributes:  # pragma no branch
            self._location = self._makeClassAttribute(
                pygithub.CodeScanAlertInstanceLocation.CodeScanAlertInstanceLocation,
                attributes["location"],
            )
