...
# Copyright 2019 Raihaan <31362124+res0nance@users.noreply.pygithub.com>         #
# Copyright 2019 Shibasis Patel <smartshibasish@gmail.com>                     #
# Copyright 2019 Steve Kowalik <steven@wedontsleep.org>                        #
# Copyright 2019 Wan Liuyang <tsfdye@gmail.com>                                #
# Copyright 2019 ebrown <brownierin@users.noreply.pygithub.com>                  #
...
# Copyright 2020 latacora-daniel <71085674+latacora-daniel@users.noreply.pygithub.com>#
# Copyright 2020 ton-katsu <sakamoto.yoshihisa@gmail.com>                      #
# Copyright 2021 James Simpson <jsimpso@users.noreply.pygithub.com>              #
...
# Copyright 2023 Oliver Mannion <125105+tekumara@users.noreply.pygithub.com>     #
# Copyright 2023 Trim21 <trim21.me@gmail.com>                                  #
# Copyright 2024 Andrii Kezikov <cheshirez@gmail.com>                          #
# Copyright 2024 Mohamed Mostafa <112487260+mohy01@users.noreply.pygithub.com>   #
# Copyright 2024 Oskar Jansson <56458534+janssonoskar@users.noreply.pygithub.com>#
...
import pygithub.OrganizationDependabotAlert
import pygithub.OrganizationSecret
import pygithub.OrganizationVariable
...
if TYPE_CHECKING:
    ...
    from pygithub.Installation import Installation
    from pygithub.Issue import Issue
    from pygithub.Label import Label
    from pygithub.Migration import Migration
    from pygithub.NamedUser import NamedUser
    from pygithub.OrganizationDependabotAlert import OrganizationDependabotAlert
    from pygithub.OrganizationSecret import OrganizationSecret
    from pygithub.OrganizationVariable import OrganizationVariable
    from pygithub.Plan import Plan
...
class Organization(CompletableGithubObject):
    ...
    def create_repo_from_template(
        ...
        headers, data = self._requester.requestJsonAndCheck(
            ...
            headers={"Accept": "application/vnd.pygithub.v3+json"},
        )
    ...
    def create_project(self, name: str, body: Opt[str] = NotSet) -> pygithub.Project.Project:
        """
    ...
    def create_secret(
        ...
        visibility: str = "all",
        selected_repositories: Opt[list[pygithub.Repository.Repository]] = NotSet,
    ) -> pygithub.OrganizationSecret.OrganizationSecret:
        """
        ...
        if visibility == "selected":
            assert isinstance(selected_repositories, list) and all(
                isinstance(element, pygithub.Repository.Repository) for element in selected_repositories
        ...
        return pygithub.OrganizationSecret.OrganizationSecret(
    ...
    def create_team(
        ...
        """
        assert isinstance(name, str), name
        assert is_optional_list(repo_names, pygithub.Repository.Repository), repo_names
    ...
    def create_variable(
        ...
        value: str,
        visibility: str = "all",
        selected_repositories: pygithub.GithubObject.Opt[list[pygithub.Repository.Repository]] = NotSet,
    ) -> pygithub.OrganizationVariable.OrganizationVariable:
        """
        ...
        :param selected_repositories: list of :class:`pygithub.Repository.Repository`
        ...
        return pygithub.OrganizationVariable.OrganizationVariable(
            requester=self._requester,
            headers={},
            attributes={
                "name": variable_name,
    ...
    def get_hook(self, id: int) -> pygithub.Hook.Hook:
        """
    ...
    def get_issues(
        ...
        :rtype: :class:`PaginatedList` of :class:`pygithub.Issue.Issue`
        :param filter: string
        :param state: string
        ...
        assert is_optional_list(labels, pygithub.Label.Label), labels
    ...
    def remove_outside_collaborator(self, collaborator: NamedUser) -> None:
        ...
        :param collaborator: :class:`pygithub.NamedUser.NamedUser`
        :rtype: None
        """
        assert isinstance(collaborator, pygithub.NamedUser.NamedUser), collaborator
        headers, data = self._requester.requestJsonAndCheck(
    ...
    def invite_user(
        ...
        :param user: :class:`pygithub.NamedUser.NamedUser`
        :param email: string
        :param role: string
        :param teams: array of :class:`pygithub.Team.Team`
        :rtype: None
        """
        assert is_optional(user, pygithub.NamedUser.NamedUser), user
        assert is_optional(email, str), email
        ...
        assert is_optional_list(teams, pygithub.Team.Team), teams
    ...
    def cancel_invitation(self, invitee: NamedUser) -> bool:
        ...
        :param invitee: :class:`pygithub.NamedUser.NamedUser`
        :rtype: None
        """
        assert isinstance(invitee, pygithub.NamedUser.NamedUser), invitee
    ...
    def create_migration(
        ...
        return pygithub.Migration.Migration(self._requester, headers, data, completed=True)
    ...
    def get_installations(self) -> PaginatedList[Installation]:
        ...
        return PaginatedList(
            pygithub.Installation.Installation,
            self._requester,
    ...
    def get_dependabot_alerts(
        ...
        :rtype: :class:`PaginatedList` of :class:`pygithub.DependabotAlert.DependabotAlert`
        """
        ...
        return PaginatedList(
            pygithub.OrganizationDependabotAlert.OrganizationDependabotAlert,
            self._requester,
