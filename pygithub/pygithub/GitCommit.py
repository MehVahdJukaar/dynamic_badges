...
class GitCommit(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._author: Attribute[pygithub.GitAuthor.GitAuthor] = NotSet
        self._committer: Attribute[pygithub.GitAuthor.GitAuthor] = NotSet
        self._html_url: Attribute[str] = NotSet
        self._message: Attribute[str] = NotSet
        self._parents: Attribute[list[GitCommit]] = NotSet
        self._sha: Attribute[str] = NotSet
        self._tree: Attribute[pygithub.GitTree.GitTree] = NotSet
    ...
    @property
    def author(self) -> pygithub.GitAuthor.GitAuthor:
        self._completeIfNotSet(self._author)
        return self._author.value

    @property
    def committer(self) -> pygithub.GitAuthor.GitAuthor:
    ...
    @property
    def tree(self) -> pygithub.GitTree.GitTree:
