...
from pygithub.Auth import AppAuth
from pygithub.GithubApp import GithubApp
from pygithub.GithubException import GithubException
from pygithub.Installation import Installation
from pygithub.InstallationAuthorization import InstallationAuthorization
...
class GithubIntegration:
    ...
    def __init__(
        ...
        *,
        ...
        """
        :param integration_id: int deprecated, use auth=pygithub.Auth.AppAuth(...) instead
        :param private_key: string deprecated, use auth=pygithub.Auth.AppAuth(...) instead
        ...
        :param jwt_expiry: int deprecated, use auth=pygithub.Auth.AppAuth(...) instead
        :param jwt_issued_at: int deprecated, use auth=pygithub.Auth.AppAuth(...) instead
        :param jwt_algorithm: string deprecated, use auth=pygithub.Auth.AppAuth(...) instead
        ...
        if (
            ...
            warnings.warn(
                ...
                "please use auth=pygithub.Auth.AppAuth(...) instead",
        ...
        assert isinstance(
            auth, AppAuth
        ), f"GithubIntegration requires pygithub.Auth.AppAuth authentication, not {type(auth)}"
    ...
    def close(self) -> None:
        ...
        .. code-block:: python
          ...
          with pygithub.GithubIntegration(...) as gi:
            # do something
        """
    ...
    def get_github_for_installation(
        ...
        return pygithub.Github(**self.__requester.withAuth(auth).kwargs)
    ...
    @deprecated.deprecated(
        "Use pygithub.Github(auth=pygithub.Auth.AppAuth), pygithub.Auth.AppAuth.token or pygithub.Auth.AppAuth.create_jwt(expiration) instead"
    )
