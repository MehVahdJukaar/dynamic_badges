...
# Copyright 2017 Colin Hoglund <colinhoglund@users.noreply.pygithub.com>         #
...
# Copyright 2018 Maarten Fonville <mfonville@users.noreply.pygithub.com>         #
# Copyright 2018 Mike Miller <pygithub@mikeage.net>                              #
# Copyright 2018 Shubham Singh <41840111+singh811@users.noreply.pygithub.com>    #
...
# Copyright 2018 h.shi <10385628+AnYeMoWang@users.noreply.pygithub.com>          #
# Copyright 2018 sfdye <tsfdye@gmail.com>                                      #
# Copyright 2019 Adam Baratz <adam.baratz@gmail.com>                           #
# Copyright 2019 Caleb Sweeney <caleb.w.sweeney@gmail.com>                     #
# Copyright 2019 Hamel Husain <hamelsmu@pygithub.com>                            #
# Copyright 2019 Isac Souza <isouza@daitan.com>                                #
# Copyright 2019 Jake Klingensmith <jklingen92@users.noreply.pygithub.com>       #
# Copyright 2019 Jake Wilkins <jakewilkins@pygithub.com>                         #
...
import pygithub.ApplicationOAuth
import pygithub.Auth
import pygithub.AuthenticatedUser
import pygithub.Enterprise
import pygithub.Event
import pygithub.Gist
import pygithub.GithubApp
import pygithub.GithubIntegration
import pygithub.GithubRetry
import pygithub.GitignoreTemplate
import pygithub.GlobalAdvisory
import pygithub.License
import pygithub.NamedUser
import pygithub.Topic
from pygithub import Consts
from pygithub.GithubIntegration import GithubIntegration
from pygithub.GithubObject import GithubObject, NotSet, Opt, is_defined
from pygithub.GithubRetry import GithubRetry
from pygithub.HookDelivery import HookDelivery, HookDeliverySummary
from pygithub.HookDescription import HookDescription
from pygithub.PaginatedList import PaginatedList
from pygithub.RateLimit import RateLimit
from pygithub.Requester import Requester

if TYPE_CHECKING:
    from pygithub.AppAuthentication import AppAuthentication
    from pygithub.ApplicationOAuth import ApplicationOAuth
    ...
    from pygithub.Gist import Gist
    from pygithub.GithubApp import GithubApp
    from pygithub.GitignoreTemplate import GitignoreTemplate
    from pygithub.GlobalAdvisory import GlobalAdvisory
    ...
    from pygithub.ProjectColumn import ProjectColumn
    from pygithub.Repository import Repository
    from pygithub.Topic import Topic
...
class Github:
    ...
    def __init__(
        ...
        auth: pygithub.Auth.Auth | None = None,
    ) -> None:
        """
        :param login_or_token: string deprecated, use auth=pygithub.Auth.Login(...) or auth=pygithub.Auth.Token(...) instead
        :param password: string deprecated, use auth=pygithub.Auth.Login(...) instead
        :param jwt: string deprecated, use auth=pygithub.Auth.AppAuth(...) or auth=pygithub.Auth.AppAuthToken(...) instead
        :param app_auth: pygithub.AppAuthentication deprecated, use auth=pygithub.Auth.AppInstallationAuth(...) instead
        ...
        :param retry: int or urllib3.util.retry.Retry object,
                      defaults to pygithub.Github.default_retry,
        ...
        assert auth is None or isinstance(auth, pygithub.Auth.Auth), auth

        if password is not None:
            warnings.warn(
                "Arguments login_or_token and password are deprecated, please use "
                "auth=pygithub.Auth.Login(...) instead",
                category=DeprecationWarning,
            )
            auth = pygithub.Auth.Login(login_or_token, password)  # type: ignore
        elif login_or_token is not None:
            warnings.warn(
                "Argument login_or_token is deprecated, please use " "auth=pygithub.Auth.Token(...) instead",
                category=DeprecationWarning,
            )
            auth = pygithub.Auth.Token(login_or_token)
        elif jwt is not None:
            warnings.warn(
                "Argument jwt is deprecated, please use "
                "auth=pygithub.Auth.AppAuth(...) or "
                "auth=pygithub.Auth.AppAuthToken(...) instead",
                category=DeprecationWarning,
            )
            auth = pygithub.Auth.AppAuthToken(jwt)
    ...
    def get_license(self, key: Opt[str] = NotSet) -> License:
        ...
        return pygithub.License.License(self.__requester, headers, data, completed=True)
    ...
    def get_licenses(self) -> PaginatedList[License]:
        ...
        return PaginatedList(pygithub.License.License, self.__requester, "/licenses", url_parameters)
    ...
    def get_events(self) -> PaginatedList[Event]:
        ...
        return PaginatedList(pygithub.Event.Event, self.__requester, "/events", None)
    ...
    def get_user(self, login: Opt[str] = NotSet) -> NamedUser | AuthenticatedUser:
        ...
        """
        if login is NotSet:
            return pygithub.AuthenticatedUser.AuthenticatedUser(self.__requester, {}, {"url": "/user"}, completed=False)
        else:
            ...
            return pygithub.NamedUser.NamedUser(self.__requester, headers, data, completed=True)
    ...
    def get_users(self, since: Opt[int] = NotSet) -> PaginatedList[NamedUser]:
        ...
        return PaginatedList(pygithub.NamedUser.NamedUser, self.__requester, "/users", url_parameters)
    ...
    def get_organization(self, login: str) -> Organization:
        ...
        return pygithub.Organization.Organization(self.__requester, headers, data, completed=True)
    ...
    def get_enterprise(self, enterprise: str) -> pygithub.Enterprise.Enterprise:
        """
        ...
        return pygithub.Enterprise.Enterprise(self.__requester, enterprise)
    ...
    def get_repo(self, full_name_or_id: int | str, lazy: bool = False) -> Repository:
        ...
        if lazy:
            return pygithub.Repository.Repository(self.__requester, {}, {"url": url}, completed=False)
        headers, data = self.__requester.requestJsonAndCheck("GET", url)
        return pygithub.Repository.Repository(self.__requester, headers, data, completed=True)
    ...
    def get_project(self, id: int) -> Project:
        ...
        return pygithub.Project.Project(self.__requester, headers, data, completed=True)
    ...
    def get_project_column(self, id: int) -> ProjectColumn:
        ...
        return pygithub.ProjectColumn.ProjectColumn(self.__requester, headers, data, completed=True)
    ...
    def get_gist(self, id: str) -> Gist:
        ...
        return pygithub.Gist.Gist(self.__requester, headers, data, completed=True)
    ...
    def get_gists(self, since: Opt[datetime] = NotSet) -> PaginatedList[Gist]:
        ...
        return PaginatedList(pygithub.Gist.Gist, self.__requester, "/gists/public", url_parameters)
    ...
    def get_global_advisory(self, ghsa_id: str) -> GlobalAdvisory:
        ...
        return pygithub.GlobalAdvisory.GlobalAdvisory(self.__requester, headers, data, completed=True)
    ...
    def get_global_advisories(
        ...
        """
        assert type is pygithub.GithubObject.NotSet or isinstance(type, str), type
        assert ghsa_id is pygithub.GithubObject.NotSet or isinstance(ghsa_id, str)
        assert cve_id is pygithub.GithubObject.NotSet or isinstance(cve_id, str), cve_id
        assert ecosystem is pygithub.GithubObject.NotSet or isinstance(ecosystem, str), ecosystem
        assert severity is pygithub.GithubObject.NotSet or isinstance(severity, str), severity
        assert cwes is pygithub.GithubObject.NotSet or isinstance(cwes, list) or isinstance(cwes, str), cwes
        assert is_withdrawn is pygithub.GithubObject.NotSet or isinstance(is_withdrawn, bool), is_withdrawn
        assert affects is pygithub.GithubObject.NotSet or isinstance(affects, list) or isinstance(affects, str), affects
        assert published is pygithub.GithubObject.NotSet or isinstance(published, str), published
        assert updated is pygithub.GithubObject.NotSet or isinstance(updated, str), updated
        assert modified is pygithub.GithubObject.NotSet or isinstance(modified, str), modified
        assert before is pygithub.GithubObject.NotSet or isinstance(before, str), before
        assert after is pygithub.GithubObject.NotSet or isinstance(after, str), after
        assert sort is pygithub.GithubObject.NotSet or isinstance(sort, str), sort
        assert direction is pygithub.GithubObject.NotSet or isinstance(direction, str), direction

        url_parameters: dict[str, Opt[str | bool]] = dict()
        if type is not pygithub.GithubObject.NotSet:  # pragma no branch (Should be covered)
            assert type in ("reviewed", "unreviewed", "malware"), type
            url_parameters["type"] = type
        if ghsa_id is not pygithub.GithubObject.NotSet:
            url_parameters["ghsa_id"] = ghsa_id
        if cve_id is not pygithub.GithubObject.NotSet:
        ...
        if ecosystem is not pygithub.GithubObject.NotSet:
            url_parameters["ecosystem"] = ecosystem
        if severity is not pygithub.GithubObject.NotSet:
            assert severity in ("null", "low", "medium", "high", "critical"), severity
            url_parameters["severity"] = severity
        if cwes is not pygithub.GithubObject.NotSet:
            if isinstance(cwes, list):
                cwes = ",".join([str(cwe) for cwe in cwes])
            url_parameters["cwes"] = cwes
        if is_withdrawn is not pygithub.GithubObject.NotSet:
            url_parameters["is_withdrawn"] = is_withdrawn
        if affects is not pygithub.GithubObject.NotSet:
            if isinstance(affects, list):
                affects = ",".join(affects)
            url_parameters["affects"] = affects
        if published is not pygithub.GithubObject.NotSet:
            url_parameters["published"] = published
        if updated is not pygithub.GithubObject.NotSet:
            url_parameters["updated"] = updated
        if modified is not pygithub.GithubObject.NotSet:
            url_parameters["modified"] = modified
        if before is not pygithub.GithubObject.NotSet:
            url_parameters["before"] = before
        if after is not pygithub.GithubObject.NotSet:
        ...
        return pygithub.PaginatedList.PaginatedList(
            pygithub.GlobalAdvisory.GlobalAdvisory,
            self.__requester,
            "/advisories",
            url_parameters,
        )
    ...
    def search_issues(
        ...
        **qualifiers: Any,
        ...
        return PaginatedList(pygithub.Issue.Issue, self.__requester, "/search/issues", url_parameters)
    ...
    def search_code(
        ...
        **qualifiers: Any,
        ...
        return PaginatedList(
            pygithub.ContentFile.ContentFile,
            self.__requester,
            "/search/code",
            url_parameters,
            headers=headers,
    ...
    def render_markdown(self, text: str, context: Opt[Repository] = NotSet) -> str:
        ...
        :param text: string
        :param context: :class:`pygithub.Repository.Repository`
        :rtype: string
        """
        assert isinstance(text, str), text
        assert context is NotSet or isinstance(context, pygithub.Repository.Repository), context
    ...
    def get_gitignore_template(self, name: str) -> GitignoreTemplate:
        ...
        return pygithub.GitignoreTemplate.GitignoreTemplate(self.__requester, headers, attributes, completed=True)
    ...
    def get_oauth_application(self, client_id: str, client_secret: str) -> ApplicationOAuth:
        return pygithub.ApplicationOAuth.ApplicationOAuth(
            self.__requester,
            headers={},
    ...
    def get_app(self, slug: Opt[str] = NotSet) -> GithubApp:
        ...
        if slug is NotSet:
            ...
            warnings.warn(
                ...
                "pygithub.GithubIntegration(auth=pygithub.Auth.AppAuth(...)).get_app() instead",
                category=DeprecationWarning,
            )
            ...
            return pygithub.GithubApp.GithubApp(self.__requester, {}, {"url": f"/apps/{slug}"}, completed=False)
