...
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet, Opt, is_optional, is_optional_list
...
class Hook(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._last_response: Attribute[pygithub.HookResponse.HookResponse] = NotSet
    ...
    @property
    def last_response(self) -> pygithub.HookResponse.HookResponse:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "last_response" in attributes:  # pragma no branch
            self._last_response = self._makeClassAttribute(
                pygithub.HookResponse.HookResponse, attributes["last_response"]
            )
