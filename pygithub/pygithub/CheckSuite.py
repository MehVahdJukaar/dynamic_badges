...
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet, Opt, is_defined, is_optional
...
class CheckSuite(CompletableGithubObject):
    ...
    def app(self) -> GithubApp:
        """
        :type: :class:`pygithub.GithubApp.GithubApp`
        """
    ...
    def pull_requests(self) -> list[PullRequest]:
        """
        :type: list of :class:`pygithub.PullRequest.PullRequest`
        """
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "app" in attributes:  # pragma no branch
            self._app = self._makeClassAttribute(pygithub.GithubApp.GithubApp, attributes["app"])
        ...
        if "head_commit" in attributes:  # pragma no branch
            ...
            self._head_commit = self._makeClassAttribute(pygithub.GitCommit.GitCommit, attributes["head_commit"])
        ...
        if "pull_requests" in attributes:  # pragma no branch
            self._pull_requests = self._makeListOfClassesAttribute(
                pygithub.PullRequest.PullRequest, attributes["pull_requests"]
            )
