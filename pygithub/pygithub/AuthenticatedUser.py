...
# Copyright 2016 E. Dunham <pygithub@edunham.net>                                #
...
# Copyright 2018 Riccardo Pittau <elfosardo@users.noreply.pygithub.com>          #
# Copyright 2018 Shubham Singh <41840111+singh811@users.noreply.pygithub.com>    #
# Copyright 2018 Steve Kowalik <steven@wedontsleep.org>                        #
# Copyright 2018 Wan Liuyang <tsfdye@gmail.com>                                #
# Copyright 2018 bryanhuntesl <31992054+bryanhuntesl@users.noreply.pygithub.com> #
...
# Copyright 2021 MeggyCal <MeggyCal@users.noreply.pygithub.com>                  #
# Copyright 2021 Steve Kowalik <steven@wedontsleep.org>                        #
# Copyright 2021 Yuya Nakamura <yuyan7sh@gmail.com>                            #
# Copyright 2021 sshekdar-VMware <87147229+sshekdar-VMware@users.noreply.pygithub.com>#
...
import pygithub.Membership
import pygithub.Migration
...
if TYPE_CHECKING:
    from pygithub.Authorization import Authorization
    from pygithub.Event import Event
    from pygithub.Gist import Gist
    from pygithub.InputFileContent import InputFileContent
    ...
    from pygithub.Membership import Membership
    ...
    from pygithub.UserKey import UserKey
...
class AuthenticatedUser(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._plan: Attribute[pygithub.Plan.Plan] = NotSet
    ...
    def create_fork(
        ...
        return repo.create_fork(
            organization=pygithub.GithubObject.NotSet,
            name=name,
    ...
    def create_gist(
        ...
        assert all(isinstance(element, pygithub.InputFileContent) for element in files.values()), files
    ...
    def get_authorizations(self) -> PaginatedList[Authorization]:
        ...
        """
        return PaginatedList(pygithub.Authorization.Authorization, self._requester, "/authorizations", None)
    ...
    def get_events(self) -> PaginatedList[Event]:
        ...
        """
        return PaginatedList(pygithub.Event.Event, self._requester, "/events", None)
    ...
    def get_followers(self) -> PaginatedList[NamedUser]:
        ...
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, "/user/followers", None)
    ...
    def get_following(self) -> PaginatedList[NamedUser]:
        ...
        """
        return PaginatedList(pygithub.NamedUser.NamedUser, self._requester, "/user/following", None)
    ...
    def get_gists(self, since: Opt[datetime] = NotSet) -> PaginatedList[Gist]:
        ...
        return PaginatedList(pygithub.Gist.Gist, self._requester, "/gists", url_parameters)
    ...
    def get_issues(
        ...
        if is_defined(since):
            url_parameters["since"] = since.strftime("%Y-%m-%dT%H:%M:%SZ")
        return PaginatedList(pygithub.Issue.Issue, self._requester, "/issues", url_parameters)
    ...
    def get_user_issues(
        ...
        if is_defined(since):
            url_parameters["since"] = since.strftime("%Y-%m-%dT%H:%M:%SZ")
        return PaginatedList(pygithub.Issue.Issue, self._requester, "/user/issues", url_parameters)
    ...
    def get_keys(self) -> PaginatedList[UserKey]:
        ...
        """
        return PaginatedList(pygithub.UserKey.UserKey, self._requester, "/user/keys", None)
    ...
    def get_notifications(
        ...
        return PaginatedList(pygithub.Notification.Notification, self._requester, "/notifications", params)
    ...
    def get_orgs(self) -> PaginatedList[Organization]:
        ...
        """
        return PaginatedList(pygithub.Organization.Organization, self._requester, "/user/orgs", None)
    ...
    def get_repos(
        ...
        return PaginatedList(pygithub.Repository.Repository, self._requester, "/user/repos", url_parameters)
    ...
    def get_starred(self) -> PaginatedList[Repository]:
        ...
        """
        return PaginatedList(pygithub.Repository.Repository, self._requester, "/user/starred", None)

    def get_starred_gists(self) -> PaginatedList[Gist]:
        """
        :calls: `GET /gists/starred <http://docs.github.com/en/rest/reference/gists>`_
        """
        return PaginatedList(pygithub.Gist.Gist, self._requester, "/gists/starred", None)
    ...
    def get_subscriptions(self) -> PaginatedList[Repository]:
        ...
        """
        return PaginatedList(pygithub.Repository.Repository, self._requester, "/user/subscriptions", None)

    def get_teams(self) -> PaginatedList[Team]:
        """
        :calls: `GET /user/teams <http://docs.github.com/en/rest/reference/teams>`_
        """
        return PaginatedList(pygithub.Team.Team, self._requester, "/user/teams", None)
    ...
    def accept_invitation(self, invitation: Invitation | int) -> None:
        ...
        """
        assert isinstance(invitation, pygithub.Invitation.Invitation) or isinstance(invitation, int)

        if isinstance(invitation, pygithub.Invitation.Invitation):
    ...
    def get_organization_membership(self, org: str) -> Membership:
        ...
        return pygithub.Membership.Membership(self._requester, headers, data, completed=True)
