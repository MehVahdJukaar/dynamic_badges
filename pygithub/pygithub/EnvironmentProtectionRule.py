...
if TYPE_CHECKING:
    from pygithub.EnvironmentProtectionRuleReviewer import EnvironmentProtectionRuleReviewer
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "reviewers" in attributes:  # pragma no branch
            self._reviewers = self._makeListOfClassesAttribute(
                pygithub.EnvironmentProtectionRuleReviewer.EnvironmentProtectionRuleReviewer,
