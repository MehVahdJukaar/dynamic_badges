...
from pygithub.GithubObject import Attribute, CompletableGithubObject, NotSet
...
class IssueEvent(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._actor: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._commit_id: Attribute[str] = NotSet
        self._created_at: Attribute[datetime] = NotSet
        self._event: Attribute[str] = NotSet
        self._id: Attribute[int] = NotSet
        self._issue: Attribute[pygithub.Issue.Issue] = NotSet
        self._url: Attribute[str] = NotSet
        self._node_id: Attribute[str] = NotSet
        self._commit_url: Attribute[str] = NotSet
        self._label: Attribute[pygithub.Label.Label] = NotSet
        self._assignee: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._assigner: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._review_requester: Attribute[pygithub.NamedUser.NamedUser] = NotSet
        self._requested_reviewer: Attribute[pygithub.NamedUser.NamedUser] = NotSet
    ...
    @property
    def actor(self) -> pygithub.NamedUser.NamedUser:
    ...
    @property
    def issue(self) -> pygithub.Issue.Issue:
    ...
    @property
    def label(self) -> pygithub.Label.Label:
    ...
    @property
    def assigner(self) -> pygithub.NamedUser.NamedUser:
        self._completeIfNotSet(self._assigner)
        return self._assigner.value

    @property
    def review_requester(self) -> pygithub.NamedUser.NamedUser:
        self._completeIfNotSet(self._review_requester)
        return self._review_requester.value

    @property
    def requested_reviewer(self) -> pygithub.NamedUser.NamedUser:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "label" in attributes:  # pragma no branch
            self._label = self._makeClassAttribute(pygithub.Label.Label, attributes["label"])
        ...
        if "assigner" in attributes:  # pragma no branch
            self._assigner = self._makeClassAttribute(pygithub.NamedUser.NamedUser, attributes["assigner"])
        if "review_requester" in attributes:  # pragma no branch
            self._review_requester = self._makeClassAttribute(
                pygithub.NamedUser.NamedUser, attributes["review_requester"]
            )
        if "requested_reviewer" in attributes:  # pragma no branch
            self._requested_reviewer = self._makeClassAttribute(
                pygithub.NamedUser.NamedUser, attributes["requested_reviewer"]
            )
