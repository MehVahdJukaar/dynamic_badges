...
class WorkflowJob(CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        ...
        self._steps: Attribute[list[pygithub.WorkflowStep.WorkflowStep]] = NotSet
    ...
    @property
    def steps(self) -> list[pygithub.WorkflowStep.WorkflowStep]:
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "steps" in attributes:  # pragma no branch
            self._steps = self._makeListOfClassesAttribute(pygithub.WorkflowStep.WorkflowStep, attributes["steps"])
