...
# Copyright 2023 terenho <33275803+terenho@users.noreply.pygithub.com>           #
# Copyright 2024 Benjamin K <53038537+treee111@users.noreply.pygithub.com>       #
#                                                                              #
...
import pygithub.BranchProtection
import pygithub.Commit
import pygithub.RequiredPullRequestReviews
import pygithub.RequiredStatusChecks
...
if TYPE_CHECKING:
    from pygithub.BranchProtection import BranchProtection
    ...
    from pygithub.RequiredPullRequestReviews import RequiredPullRequestReviews
    from pygithub.RequiredStatusChecks import RequiredStatusChecks
...
class Branch(NonCompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._commit: Attribute[Commit] = pygithub.GithubObject.NotSet
        self._name: Attribute[str] = pygithub.GithubObject.NotSet
        self._protection_url: Attribute[str] = pygithub.GithubObject.NotSet
        self._protected: Attribute[bool] = pygithub.GithubObject.NotSet
    ...
    def get_protection(self) -> BranchProtection:
        ...
        return pygithub.BranchProtection.BranchProtection(self._requester, headers, data, completed=True)
    ...
    def get_required_status_checks(self) -> RequiredStatusChecks:
        ...
        return pygithub.RequiredStatusChecks.RequiredStatusChecks(self._requester, headers, data, completed=True)
    ...
    def get_required_pull_request_reviews(self) -> RequiredPullRequestReviews:
        ...
        return pygithub.RequiredPullRequestReviews.RequiredPullRequestReviews(
