...
from pygithub.AdvisoryBase import AdvisoryBase
from pygithub.AdvisoryCredit import AdvisoryCredit, Credit
from pygithub.AdvisoryCreditDetailed import AdvisoryCreditDetailed
from pygithub.GithubObject import Attribute, NotSet, Opt

if TYPE_CHECKING:
    from pygithub.AdvisoryVulnerability import AdvisoryVulnerability, AdvisoryVulnerabilityInput
...
class RepositoryAdvisory(AdvisoryBase):
    ...
    def offer_credit(
        self,
        login_or_user: str | pygithub.NamedUser.NamedUser,
        credit_type: str,
    ) -> None:
        """
    ...
    def revoke_credit(self, login_or_user: str | pygithub.NamedUser.NamedUser) -> None:
        """
        ...
        """
        assert isinstance(login_or_user, (str, pygithub.NamedUser.NamedUser)), login_or_user
        if isinstance(login_or_user, pygithub.NamedUser.NamedUser):
    ...
    def _useAttributes(self, attributes: dict[str, Any]) -> None:
        ...
        if "vulnerabilities" in attributes:
            self._vulnerabilities = self._makeListOfClassesAttribute(
                pygithub.AdvisoryVulnerability.AdvisoryVulnerability,
