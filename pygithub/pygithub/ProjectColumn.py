...
# Copyright 2019 Vincent <pygithub@fleeto.us>                                    #
...
class ProjectColumn(CompletableGithubObject):
    ...
    def get_cards(self, archived_state: Opt[str] = NotSet) -> PaginatedList[pygithub.ProjectCard.ProjectCard]:
        """
    ...
    def create_card(
        ...
        return pygithub.ProjectCard.ProjectCard(self._requester, headers, data, completed=True)
