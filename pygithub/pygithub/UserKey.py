...
class UserKey(pygithub.GithubObject.CompletableGithubObject):
    ...
    def _initAttributes(self) -> None:
        self._id: Attribute[int] = pygithub.GithubObject.NotSet
        self._key: Attribute[str] = pygithub.GithubObject.NotSet
        self._title: Attribute[str] = pygithub.GithubObject.NotSet
        self._url: Attribute[str] = pygithub.GithubObject.NotSet
        self._verified: Attribute[bool] = pygithub.GithubObject.NotSet
