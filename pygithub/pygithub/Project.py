...
class Project(CompletableGithubObject):
    ...
    def create_column(self, name: str) -> pygithub.ProjectColumn.ProjectColumn:
        """
        ...
        return pygithub.ProjectColumn.ProjectColumn(self._requester, headers, data, completed=True)
